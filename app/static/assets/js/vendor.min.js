!(function (t, e) {
	...
	(A.fn = A.prototype =
		...
		A.extend({
			...
			isPlainObject: function (t) {
				return !(
					...
					((t = R(t)) &&
						("function" !=
							typeof (t =
								I.call(t, "constructor") && t.constructor) ||
							j.call(t) !== W))
				);
			},
			...
			makeArray: function (t, e) {
				...
				return (
					null != t &&
						(K(Object(t))
							? A.merge(e, "string" == typeof t ? [t] : t)
							: z.call(e, t)),
					e
				);
			},
			inArray: function (t, e, a) {
				return null == e ? -1 : y.call(e, t, a);
			},
			isXMLDoc: function (t) {
				var e = t && t.namespaceURI,
					t = t && (t.ownerDocument || t).documentElement;
				return !$.test(e || (t && t.nodeName) || "HTML");
			},
			merge: function (t, e) {
				for (var a = +e.length, i = 0, r = t.length; i < a; i++)
					t[r++] = e[i];
				return (t.length = r), t;
			},
			grep: function (t, e, a) {
				for (var i = [], r = 0, h = t.length, n = !a; r < h; r++)
					!e(t[r], r) != n && i.push(t[r]);
				return i;
			},
			map: function (t, e, a) {
				var i,
					...
					n = [];
				if (K(t))
					for (i = t.length; h < i; h++)
						null != (r = e(t[h], h, a)) && n.push(r);
				else for (h in t) null != (r = e(t[h], h, a)) && n.push(r);
				return q(n);
			},
			guid: 1,
			support: g,
		...
		"function" == typeof Symbol &&
			(A.fn[Symbol.iterator] = e[Symbol.iterator]),
		A.each(
	...
	var it,
		...
		Lt = Rt(
			function (t) {
				return !0 === t.disabled && x(t, "fieldset");
			},
			{ dir: "parentNode", next: "legend" }
		);
	try {
		_.apply((e = s.call(r.childNodes)), r.childNodes),
			e[r.childNodes.length].nodeType;
	} catch (it) {
		_ = {
			apply: function (t, e) {
				ot.apply(t, s.call(e));
	...
	function V(t, e, a, i) {
		...
		if (!i && (Pt(e), (e = e || S), H)) {
			if (11 !== p && (s = St.exec(t)))
				if ((r = s[1])) {
					if (9 === p) {
						if (!(d = e.getElementById(r))) return a;
						if (d.id === r) return _.call(a, d), a;
					} else if (
						l &&
						(d = l.getElementById(r)) &&
						V.contains(e, d) &&
						d.id === r
					)
						return _.call(a, d), a;
				} else {
					if (s[2]) return _.apply(a, e.getElementsByTagName(t)), a;
					if ((r = s[3]) && e.getElementsByClassName)
						return _.apply(a, e.getElementsByClassName(r)), a;
				}
			if (!(vt[t + " "] || (c && c.test(t)))) {
				if (((d = t), (l = e), 1 === p && (yt.test(t) || mt.test(t)))) {
					for (
						((l = (Ht.test(t) && Dt(e.parentNode)) || e) == e &&
							g.scope) ||
							((n = e.getAttribute("id"))
								? (n = A.escapeSelector(n))
								: e.setAttribute("id", (n = L))),
							h = (o = Ft(t)).length;
						h--;

					)
						o[h] = (n ? "#" + n : ":scope") + " " + Bt(o[h]);
					d = o.join(",");
				}
				try {
					return _.apply(a, l.querySelectorAll(d)), a;
				} catch (e) {
					vt(t, !0);
				} finally {
					n === L && e.removeAttribute("id");
				}
			}
		}
		return It(t.replace(tt, "$1"), e, a, i);
	}
	function kt() {
		var i = [];
	...
	function Et(n) {
		return T(function (h) {
			return (
				(h = +h),
				T(function (t, e) {
					for (var a, i = n([], t.length, h), r = i.length; r--; )
						t[(a = i[r])] && (t[a] = !(e[a] = t[a]));
				})
			);
		});
		...
		return (
			t != S &&
				...
				i.msMatchesSelector &&
					...
					(t = S.defaultView) &&
					t.top !== t &&
					t.addEventListener("unload", _t),
				(g.getById = Vt(function (t) {
					return (
						(i.appendChild(t).id = A.expando),
						!S.getElementsByName ||
							!S.getElementsByName(A.expando).length
					);
				})),
				(g.disconnectedMatch = Vt(function (t) {
					return st.call(t, "*");
				})),
				(g.scope = Vt(function () {
					return S.querySelectorAll(":scope");
				})),
				(g.cssHas = Vt(function () {
					try {
					  ...
					  (w.find.ID = function (t, e) {
							if (void 0 !== e.getElementById && H) {
								var a,
									i,
									r,
									h = e.getElementById(t);
								if (h) {
									if (
										(a = h.getAttributeNode("id")) &&
										a.value === t
									)
										return [h];
									for (
								...
								(1 &
									(a =
										...
										(e.ownerDocument || e)
											...
											: 1) ||
								(!g.sortDetached &&
									e.compareDocumentPosition(t) === a)
									? t === S ||
									  (t.ownerDocument == r && V.contains(r, t))
										? -1
										: e === S ||
										  (e.ownerDocument == r &&
												V.contains(r, e))
	...
	for (it in ((V.matches = function (t, e) {
		return V(t, null, null, e);
	}),
	(V.matchesSelector = function (t, e) {
		if ((Pt(t), H && !vt[e + " "] && (!c || !c.test(e))))
			try {
				var a = st.call(t, e);
				if (
					a ||
		...
		return 0 < V(e, S, null, [t]).length;
	}),
	(V.contains = function (t, e) {
		return (t.ownerDocument || t) != S && Pt(t), A.contains(t, e);
	}),
	(V.attr = function (t, e) {
		(t.ownerDocument || t) != S && Pt(t);
		var a = w.attrHandle[e.toLowerCase()],
			a =
				a && I.call(w.attrHandle, e.toLowerCase())
					? a(t, e, !H)
					: void 0;
		return void 0 !== a ? a : t.getAttribute(e);
	}),
	(V.error = function (t) {
	...
	(A.uniqueSort = function (t) {
		...
		if (
			((nt = !g.sortStable),
			(ht = !g.sortStable && s.call(t, 0)),
			Q.call(t, ut),
			nt)
		) {
			for (; (e = t[r++]); ) e === t[r] && (i = a.push(r));
			for (; i--; ) J.call(t, a[i], 1);
		}
		return (ht = null), t;
	}),
	...
	((w = A.expr =
		{
			...
			filter: {
				TAG: function (t) {
					var e = t.replace(p, v).toLowerCase();
					return "*" === t
						? function () {
								return !0;
						  }
				...
				CHILD: function (v, t, e, u, g) {
					var M = "nth" !== v.slice(0, 3),
						f = "last" !== v.slice(-4),
						m = "of-type" === t;
					return 1 === u && 0 === g
						? function (t) {
					...
					return n[L]
						...
						? ((e = [t, t, "", h]),
						  w.setFilters.hasOwnProperty(t.toLowerCase())
								? T(function (t, e) {
										for (
											var a, i = n(t, h), r = i.length;
											r--;

										)
											t[(a = y.call(t, i[r]))] = !(e[a] =
												i[r]);
								  })
								: function (t) {
										return n(t, 0, e);
			...
			pseudos: {
				...
				contains: T(function (e) {
					return (
						(e = e.replace(p, v)),
						function (t) {
							return -1 < (t.textContent || A.text(t)).indexOf(e);
						}
					);
				}),
				lang: T(function (a) {
					return (
						wt.test(a || "") || V.error("unsupported lang: " + a),
						(a = a.replace(p, v).toLowerCase()),
						function (t) {
							var e;
							do {
								if (
				...
				button: function (t) {
					return (
						(x(t, "input") && "button" === t.type) || x(t, "button")
					);
				},
				text: function (t) {
					return (
				...
				last: Et(function (t, e) {
					return [e - 1];
				}),
				eq: Et(function (t, e, a) {
					return [a < 0 ? a + e : a];
				}),
				even: Et(function (t, e) {
				...
				lt: Et(function (t, e, a) {
					for (var i = a < 0 ? a + e : e < a ? e : a; 0 <= --i; )
						t.push(i);
					return t;
				}),
				gt: Et(function (t, e, a) {
	...
	function Ft(t, e) {
		...
		for (n = t, s = [], o = w.preFilter; n; ) {
			for (h in ((a && !(i = ft.exec(n))) ||
				(i && (n = n.slice(i[0].length) || n), s.push((r = []))),
			(a = !1),
			(i = mt.exec(n)) &&
				((a = i.shift()),
				r.push({ value: a, type: i[0].replace(tt, " ") }),
				(n = n.slice(a.length))),
			w.filter))
				!(i = bt[h].exec(n)) ||
					(o[h] && !(i = o[h](i))) ||
					((a = i.shift()),
					r.push({ value: a, type: h, matches: i }),
					(n = n.slice(a.length)));
			if (!a) break;
		}
		return e ? n.length : n ? V.error(t) : pt(t, s).slice(0);
	}
	function Bt(t) {
	...
	function Rt(n, t, e) {
		...
		return t.first
			? function (t, e, a) {
					for (; (t = t[s]); )
						if (1 === t.nodeType || l) return n(t, e, a);
					return !1;
			  }
			: function (t, e, a) {
					var i,
					...
					if (a) {
						for (; (t = t[s]); )
							if ((1 === t.nodeType || l) && n(t, e, a))
								return !0;
					} else
						for (; (t = t[s]); )
							if (1 === t.nodeType || l)
								if (((r = t[L] || (t[L] = {})), o && x(t, o)))
									t = t[s] || t;
								else {
									if ((i = r[d]) && i[0] === k && i[1] === p)
										return (h[2] = i[2]);
									if (((r[d] = h)[2] = n(t, e, a))) return !0;
								}
					return !1;
			  };
	}
	function qt(r) {
		return 1 < r.length
			? function (t, e, a) {
					for (var i = r.length; i--; ) if (!r[i](t, e, a)) return !1;
					return !0;
			  }
			: r[0];
	}
	function zt(t, e, a, i, r) {
		for (var h, n = [], s = 0, o = t.length, d = null != e; s < o; s++)
			!(h = t[s]) || (a && !a(h, i, r)) || (n.push(h), d && e.push(s));
		return n;
	}
	function Zt(t) {
		for (
			...
			if ((e = w.relative[t[s].type])) l = [Rt(qt(l), e)];
			else {
				if ((e = w.filter[t[s].type].apply(null, t[s].matches))[L]) {
					for (a = ++s; a < r && !w.relative[t[a].type]; a++);
					return (function t(v, u, g, M, f, e) {
						return (
							M && !M[L] && (M = t(M)),
							f && !f[L] && (f = t(f, e)),
							T(function (t, e, a, i) {
								...
								} else (s = zt(s === e ? s.splice(l, s.length) : s)), f ? f(null, e, s, i) : _.apply(e, s);
							})
						);
					})(
						1 < s && qt(l),
	...
	function Nt(t, e) {
		var a,
			...
			n = ct[t + " "];
		if (!n) {
			for (a = (e = e || Ft(t)).length; a--; )
				((n = Zt(e[a]))[L] ? r : h).push(n);
			(n = ct(
				t,
				((m = 0 < (f = r).length),
				(y = 0 < (M = h).length),
				(i = function (t, e, a, i, r) {
					...
					for (
						...
						m && ((h = !s && h) && o--, t) && l.push(h);
					}
					if (((o += d), m && d !== o)) {
						for (n = 0; (s = f[n++]); ) s(l, p, e, a);
						if (t) {
							if (0 < o)
								for (; d--; )
									l[d] || p[d] || (p[d] = Y.call(i));
							p = zt(p);
						}
						_.apply(i, p),
							r &&
	...
	function It(t, e, a, i) {
		...
		if (((a = a || []), 1 === l.length)) {
			if (
				...
				if (!(e = (w.find.ID(n.matches[0].replace(p, v), e) || [])[0]))
					return a;
				d && (e = e.parentNode), (t = t.slice(h.shift().value.length));
			}
			for (
				r = bt.needsContext.test(t) ? 0 : h.length;
				r-- && ((n = h[r]), !w.relative[(s = n.type)]);

			)
				if (
					(o = w.find[s]) &&
					(i = o(
						n.matches[0].replace(p, v),
						(Ht.test(h[0].type) && Dt(e.parentNode)) || e
					))
				) {
					if ((h.splice(r, 1), (t = i.length && Bt(h)))) break;
					return _.apply(a, i), a;
				}
		}
		return (
			(d || Nt(t, l))(
				...
				!H,
				a,
				!e || (Ht.test(t) && Dt(e.parentNode)) || e
			),
			a
		);
	}
	(Ot.prototype = w.filters = w.pseudos),
		(w.setFilters = new Ot()),
		(g.sortStable = L.split("").sort(ut).join("") === L),
		Pt(),
		(g.sortDetached = Vt(function (t) {
		...
		(V.setDocument = Pt),
		(V.tokenize = Ft),
		(V.escape = A.escapeSelector),
		(V.getText = A.text),
		(V.isXML = A.isXMLDoc),
		(V.selectors = A.expr),
		(V.support = A.support),
		(V.uniqueSort = A.uniqueSort);
	function jt(t, e, a) {
		for (var i = [], r = void 0 !== a; (t = t[e]) && 9 !== t.nodeType; )
			if (1 === t.nodeType) {
				if (r && A(t).is(a)) break;
				i.push(t);
			}
	...
	var Ut = A.expr.match.needsContext,
		Gt = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
	function Xt(t, a, i) {
		return m(a)
	...
	(A.filter = function (t, e, a) {
		...
		A.fn.extend({
			find: function (t) {
				...
				if ("string" != typeof t)
					return this.pushStack(
						A(t).filter(function () {
							for (e = 0; e < i; e++)
								if (A.contains(r[e], this)) return !0;
						})
					);
				for (a = this.pushStack([]), e = 0; e < i; e++)
					A.find(t, r[e], a);
			...
			is: function (t) {
				return !!Xt(
					this,
					"string" == typeof t && Ut.test(t) ? A(t) : t || [],
					!1
				).length;
			},
		});
			...
			(((A.fn.init = function (t, e, a) {
				if (t) {
					...
					if (
						...
						return (
							!e || e.jquery ? e || a : this.constructor(e)
						).find(t);
					if (i[1]) {
						if (
							...
							Gt.test(i[1]) && A.isPlainObject(e))
						)
							for (var i in e)
								m(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
					} else
						(a = C.getElementById(i[2])) &&
					...
					for (a = this[i]; a && a !== e; a = a.parentNode)
						if (
							...
							(n
								? -1 < n.index(a)
								: 1 === a.nodeType &&
								  A.find.matchesSelector(a, t))
						) {
							h.push(a);
							break;
						}
			return this.pushStack(1 < h.length ? A.uniqueSort(h) : h);
		},
		index: function (t) {
			return t
				? "string" == typeof t
		...
		A.each(
			{
				...
				nextUntil: function (t, e, a) {
					return jt(t, "nextSibling", a);
				},
				prevUntil: function (t, e, a) {
					return jt(t, "previousSibling", a);
				},
				siblings: function (t) {
				...
				contents: function (t) {
					return null != t.contentDocument && R(t.contentDocument)
						? t.contentDocument
						: (x(t, "template") && (t = t.content || t),
						  A.merge([], t.childNodes));
				},
			},
			function (i, r) {
				A.fn[i] = function (t, e) {
					var a = A.map(this, r, t);
					return (
						(e = "Until" !== i.slice(-5) ? t : e) &&
							"string" == typeof e &&
							(a = A.filter(e, a)),
						1 < this.length &&
							(Qt[i] || A.uniqueSort(a), Yt.test(i)) &&
							a.reverse(),
						this.pushStack(a)
					);
				};
	...
	(A.Callbacks = function (i) {
		...
		i =
			"string" == typeof i
				? ((t = i),
				  (a = {}),
				  A.each(t.match(E) || [], function (t, e) {
						a[e] = !0;
				  }),
				  a)
				: A.extend({}, i);
		function r() {
			for (s = s || i.once, n = h = !0; d.length; l = -1)
				for (e = d.shift(); ++l < o.length; )
					!1 === o[l].apply(e[0], e[1]) &&
						i.stopOnFalse &&
						((l = o.length), (e = !1));
			i.memory || (e = !1), (h = !1), s && (o = e ? [] : "");
		}
		var h,
			e,
			n,
			...
			p = {
				add: function () {
					return (
						o &&
							(e && !h && ((l = o.length - 1), d.push(e)),
							(function a(t) {
								A.each(t, function (t, e) {
									m(e)
										? (i.unique && p.has(e)) || o.push(e)
										: e &&
										  e.length &&
										  "string" !== X(e) &&
										  a(e);
				...
				has: function (t) {
					return t ? -1 < A.inArray(t, o) : 0 < o.length;
				},
				empty: function () {
					return (o = o && []), this;
				},
					...
					n = {
						...
						then: function (e, a, i) {
							...
							return A.Deferred(function (t) {
								h[0][3].add(
									d(0, t, m(i) ? i : t1, t.notifyWith)
								),
									h[1][3].add(d(0, t, m(e) ? e : t1)),
									h[2][3].add(d(0, t, m(a) ? a : e1));
							}).promise();
						},
						promise: function (t) {
			...
			when: function (t) {
				function e(e) {
					return function (t) {
						(r[e] = this),
							(h[e] =
								1 < arguments.length ? s.call(arguments) : t),
							--a || n.resolveWith(r, h);
					};
				}
				...
				if (
					a <= 1 &&
					(a1(t, n.done(e(i)).resolve, n.reject, !a),
					"pending" === n.state() || m(h[i] && h[i].then))
				)
					return n.then();
				for (; i--; ) a1(h[i], e(i), n.reject);
				return n.promise();
			},
		});
	var i1 = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/,
		r1 =
			...
			A.Deferred());
	function h1() {
		C.removeEventListener("DOMContentLoaded", h1),
			b.removeEventListener("load", h1),
			A.ready();
	}
	(A.fn.ready = function (t) {
		return (
			r1.then(t).catch(function (t) {
				A.readyException(t);
			}),
			this
		);
		...
		(A.ready.then = r1.then),
		"complete" === C.readyState ||
		("loading" !== C.readyState && !C.documentElement.doScroll)
			? b.setTimeout(A.ready)
			: (C.addEventListener("DOMContentLoaded", h1),
			  b.addEventListener("load", h1));
	function l(t, e, a, i, r, h, n) {
		var s = 0,
			o = t.length,
			d = null == a;
		if ("object" === X(a))
			for (s in ((r = !0), a)) l(t, e, s, a[s], !0, h, n);
		else if (
			void 0 !== i &&
			((r = !0),
			m(i) || (n = !0),
			...
			for (; s < o; s++) e(t[s], a, n ? i : i.call(t[s], s, e(t[s], a)));
		return r ? t : d ? e.call(t) : o ? e(t[0], a) : h;
	}
	var n1 = /^-ms-/,
		s1 = /-([a-z])/g;
	function o1(t, e) {
	...
	function D(t) {
		return t.replace(n1, "ms-").replace(s1, o1);
	}
	function d1(t) {
		return 1 === t.nodeType || 9 === t.nodeType || !+t.nodeType;
	}
	function l1() {
		this.expando = A.expando + l1.uid++;
	}
	(l1.uid = 1),
		(l1.prototype = {
			cache: function (t) {
	...
	A.extend({
		hasData: function (t) {
			return o.hasData(t) || f.hasData(t);
		},
		data: function (t, e, a) {
			return o.access(t, e, a);
		},
		removeData: function (t, e) {
			o.remove(t, e);
		},
		_data: function (t, e, a) {
			return f.access(t, e, a);
		},
		...
		A.fn.extend({
			data: function (a, t) {
				...
				if (
					this.length &&
					((r = o.get(h)), 1 === h.nodeType) &&
					!f.get(h, "hasDataAttrs")
				) {
					for (e = n.length; e--; )
						n[e] &&
							0 === (i = n[e].name).indexOf("data-") &&
							((i = D(i.slice(5))), v1(h, i, r[i]));
		...
		A.extend({
			queue: function (t, e, a) {
				...
				if (t)
					return (
						(i = f.get(t, (e = (e || "fx") + "queue"))),
						a &&
							(!i || Array.isArray(a)
								? (i = f.access(t, e, A.makeArray(a)))
								: i.push(a)),
						i || []
					);
			},
		...
		A.fn.extend({
			...
			promise: function (t, e) {
				...
				for (
					...
					(i = f.get(n[s], t + "queueHooks")) &&
						i.empty &&
						(r++, i.empty.add(a));
				return a(), h.promise(e);
			},
		});
	function u1(t, e) {
		return (
			"none" === (t = e || t).style.display ||
			("" === t.style.display && m1(t) && "none" === A.css(t, "display"))
		);
	}
	var t = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
		g1 = new RegExp("^(?:([+-])=|)(" + t + ")([a-z%]*)$", "i"),
		M1 = ["Top", "Right", "Bottom", "Left"],
		f1 = C.documentElement,
		m1 = function (t) {
	...
	f1.getRootNode &&
		(m1 = function (t) {
			return (
				...
				t.getRootNode(y1) === t.ownerDocument
			);
		});
	function x1(t, e, a, i) {
		var r,
			...
			o = s(),
			d = (a && a[3]) || (A.cssNumber[e] ? "" : "px"),
			l =
				t.nodeType &&
				(A.cssNumber[e] || ("px" !== d && +o)) &&
				g1.exec(A.css(t, e));
		if (l && l[3] !== d) {
			for (d = d || l[3], l = +(o /= 2) || 1; n--; )
				A.style(t, e, l + d),
					(1 - h) * (1 - (h = s() / o || 0.5)) <= 0 && (n = 0),
					(l /= h);
			A.style(t, e, (l *= 2) + d), (a = a || []);
		}
		return (
			a &&
				((l = +l || +o || 0),
				(r = a[1] ? l + (a[1] + 1) * a[2] : +a[2]),
				i) &&
				((i.unit = d), (i.start = l), (i.end = r)),
			r
		);
	}
	var w1 = {};
	function b1(t, e) {
		for (var a, i, r, h, n, s, o = [], d = 0, l = t.length; d < l; d++)
			(i = t[d]).style &&
				((a = i.style.display),
				e
					? ("none" === a &&
							((o[d] = f.get(i, "display") || null),
							o[d] || (i.style.display = "")),
					  "" === i.style.display &&
							u1(i) &&
							(o[d] =
								...
								(n = i.nodeName),
								(s = w1[n]) ||
									((r = h.body.appendChild(
										h.createElement(n)
									)),
									(s = A.css(r, "display")),
									r.parentNode.removeChild(r),
									(w1[n] = s = "none" === s ? "block" : s)))))
					: "none" !== a &&
					  ((o[d] = "none"), f.set(i, "display", a)));
		for (d = 0; d < l; d++) null != o[d] && (t[d].style.display = o[d]);
		return t;
	}
	A.fn.extend({
		show: function () {
		...
		toggle: function (t) {
			return "boolean" == typeof t
				? t
					...
					: this.hide()
				: this.each(function () {
						u1(this) ? A(this).show() : A(this).hide();
				  });
		},
	});
	var C1 = /^(?:checkbox|radio)$/i,
		A1 = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i,
		S1 = /^$|^module$|\/(?:java|ecma)script/i,
		h = C.createDocumentFragment().appendChild(C.createElement("div")),
		u =
			((n = C.createElement("input")).setAttribute("type", "radio"),
			n.setAttribute("checked", "checked"),
			n.setAttribute("name", "t"),
			h.appendChild(n),
			(g.checkClone = h.cloneNode(!0).cloneNode(!0).lastChild.checked),
			(h.innerHTML = "<textarea>x</textarea>"),
			(g.noCloneChecked = !!h.cloneNode(!0).lastChild.defaultValue),
			(h.innerHTML = "<option></option>"),
			(g.option = !!h.lastChild),
			{
				thead: [1, "<table>", "</table>"],
	...
	function M(t, e) {
		var a =
			void 0 !== t.getElementsByTagName
				...
				: [];
		return void 0 === e || (e && x(t, e)) ? A.merge([t], a) : a;
	}
	function H1(t, e) {
		for (var a = 0, i = t.length; a < i; a++)
			f.set(t[a], "globalEval", !e || f.get(e[a], "globalEval"));
	}
	...
	function L1(t, e, a, i, r) {
		for (
			...
			if ((h = t[c]) || 0 === h)
				if ("object" === X(h)) A.merge(p, h.nodeType ? [h] : h);
				else if (_1.test(h)) {
					for (
						n = n || l.appendChild(e.createElement("div")),
							s = (A1.exec(h) || ["", ""])[1].toLowerCase(),
							s = u[s] || u._default,
							n.innerHTML = s[1] + A.htmlPrefilter(h) + s[2],
							d = s[0];
						d--;

					)
						n = n.lastChild;
					A.merge(p, n.childNodes),
						((n = l.firstChild).textContent = "");
				} else p.push(e.createTextNode(h));
		for (l.textContent = "", c = 0; (h = p[c++]); )
			if (i && -1 < A.inArray(h, i)) r && r.push(h);
			else if (
				((o = m1(h)),
				(n = M(l.appendChild(h), "script")),
				o && H1(n),
				a)
			)
				for (d = 0; (h = n[d++]); ) S1.test(h.type || "") && a.push(h);
		return l;
	}
	var k1 = /^([^.]*)(?:\.(.+)|)/;
	function V1() {
	...
	function E1(t, e, a, i, r, h) {
		var n, s;
		if ("object" == typeof e) {
			for (s in ("string" != typeof a && ((i = i || a), (a = void 0)), e))
				E1(t, s, a, i, e[s], h);
			return t;
		}
		if (
		...
		return (
			1 === h &&
				((n = r),
				((r = function (t) {
					return A().off(t), n.apply(this, arguments);
				}).guid = n.guid || (n.guid = A.guid++))),
			t.each(function () {
				A.event.add(this, e, r, i, a);
			})
		);
	}
	function D1(t, i, e) {
						...
						if (1 & t.isTrigger && this[i]) {
							...
							a &&
								(f.set(
									this,
									i,
									A.event.trigger(a[0], a.slice(1), this)
								),
								t.stopPropagation(),
								(t.isImmediatePropagationStopped = V1));
					},
			  }))
			: void 0 === f.get(t, i) && A.event.add(t, i, V1);
	}
	(A.event = {
		global: {},
		add: function (e, t, a, i, r) {
			...
			if (d1(e))
				for (
					a.handler && ((a = (h = a).handler), (r = h.selector)),
						r && A.find.matchesSelector(f1, r),
						a.guid || (a.guid = A.guid++),
						s = (s = u.events) || (u.events = Object.create(null)),
						n =
							(n = u.handle) ||
							(u.handle = function (t) {
								return void 0 !== A &&
					...
					(p = v = (c = k1.exec(t[o]) || [])[1]),
						...
						p &&
							...
							(l = s[p]) ||
								(((l = s[p] = []).delegateCount = 0),
								d.setup && !1 !== d.setup.call(e, i, c, n)) ||
								(e.addEventListener &&
									e.addEventListener(p, n)),
							d.add &&
								(d.add.call(e, v),
								v.handler.guid || (v.handler.guid = a.guid)),
							r ? l.splice(l.delegateCount++, 0, v) : l.push(v),
							(A.event.global[p] = !0));
		},
		remove: function (t, e, a, i, r) {
			var h,
				n,
				s,
				o,
				...
				for (d = (e = (e || "").match(E) || [""]).length; d--; )
					if (
						...
						n &&
							!c.length &&
							((p.teardown &&
								!1 !== p.teardown.call(t, u, M.handle)) ||
								A.removeEvent(t, v, M.handle),
							delete o[v]);
					} else for (v in o) A.event.remove(t, v + e[d], a, i, !0);
				A.isEmptyObject(o) && f.remove(t, "handle events");
			}
		},
		dispatch: function (t) {
			var e,
				...
				s = A.event.fix(t),
				t =
					(f.get(this, "events") || Object.create(null))[s.type] ||
					[],
				o = A.event.special[s.type] || {};
			for (n[0] = s, e = 1; e < arguments.length; e++)
				n[e] = arguments[e];
			if (
				((s.delegateTarget = this),
				!o.preDispatch || !1 !== o.preDispatch.call(this, s))
			) {
				for (
					h = A.event.handlers.call(this, s, t), e = 0;
					(i = h[e++]) && !s.isPropagationStopped();
					...
					for (
						...
						(s.rnamespace &&
							...
							void 0 !==
								(r = (
									(A.event.special[r.origType] || {})
										.handle || r.handler
								).apply(i.elem, n)) &&
								!1 === (s.result = r) &&
								(s.preventDefault(), s.stopPropagation()));
				return o.postDispatch && o.postDispatch.call(this, s), s.result;
			}
		},
		handlers: function (t, e) {
			var a,
				...
				o = e.delegateCount,
				d = t.target;
			if (o && d.nodeType && !("click" === t.type && 1 <= t.button))
				for (; d !== this; d = d.parentNode || this)
					if (
						...
						for (h = [], n = {}, a = 0; a < o; a++)
							void 0 === n[(r = (i = e[a]).selector + " ")] &&
								(n[r] = i.needsContext
									? -1 < A(r, this).index(d)
									: A.find(r, this, null, [d]).length),
								n[r] && h.push(i);
						h.length && s.push({ elem: d, handlers: h });
					}
			return (
				(d = this),
				o < e.length && s.push({ elem: d, handlers: e.slice(o) }),
				s
			);
		},
		...
		(A.Event.prototype = {
			...
			stopImmediatePropagation: function () {
				var t = this.originalEvent;
				(this.isImmediatePropagationStopped = V1),
		...
		A.each({ focus: "focusin", blur: "focusout" }, function (i, r) {
			function h(t) {
				var e, a;
				C.documentMode
					? ((e = f.get(this, "handle")),
					  ((a = A.event.fix(t)).type =
							"focusin" === t.type ? "focus" : "blur"),
					  (a.isSimulated = !0),
					  e(t),
					  a.target === a.currentTarget && e(a))
					: A.event.simulate(r, t.target, A.event.fix(t));
			}
			(A.event.special[i] = {
				setup: function () {
					var t;
					if ((D1(this, i, !0), !C.documentMode)) return !1;
					(t = f.get(this, r)) || this.addEventListener(r, h),
						f.set(this, r, (t || 0) + 1);
				},
				trigger: function () {
					return D1(this, i), !0;
				...
				teardown: function () {
					...
					(t = f.get(this, r) - 1)
						? f.set(this, r, t)
						: (this.removeEventListener(r, h), f.remove(this, r));
				},
				_default: function (t) {
					return f.get(t.target, i);
				},
				delegateType: r,
			}),
				(A.event.special[r] = {
					setup: function () {
						...
						a ||
							(C.documentMode
								? this.addEventListener(r, h)
								: t.addEventListener(i, h, !0)),
							f.set(e, r, (a || 0) + 1);
					},
					teardown: function () {
						var t = this.ownerDocument || this.document || this,
						...
						a
							? f.set(e, r, a)
							: (C.documentMode
									? this.removeEventListener(r, h)
									: t.removeEventListener(i, h, !0),
							  f.remove(e, r));
					},
				});
		}),
		...
		A.fn.extend({
			on: function (t, e, a, i) {
				return E1(this, t, e, a, i);
			},
			one: function (t, e, a, i) {
				return E1(this, t, e, a, i, 1);
			},
			off: function (t, e, a) {
				var i, r;
	...
	var P1 = /<script|<style|<link/i,
		O1 = /checked\s*(?:[^=]|=\s*.checked.)/i,
		F1 = /^\s*<!\[CDATA\[|\]\]>\s*$/g;
	function B1(t, e) {
		return (
			(x(t, "table") &&
				x(11 !== e.nodeType ? e : e.firstChild, "tr") &&
	...
	function z1(t, e) {
		var a, i, r, h;
		if (1 === e.nodeType) {
			if (f.hasData(t) && (h = f.get(t).events))
				for (r in (f.remove(e, "handle events"), h))
					for (a = 0, i = h[r].length; a < i; a++)
						A.event.add(e, r, h[r][a]);
			o.hasData(t) &&
				((t = o.access(t)), (t = A.extend({}, t)), o.set(e, t));
		}
	}
	function Z1(a, i, r, h) {
		i = q(i);
		var t,
			...
			v = i[0],
			u = m(v);
		if (u || (1 < p && "string" == typeof v && !g.checkClone && O1.test(v)))
			return a.each(function (t) {
				var e = a.eq(t);
				u && (i[0] = v.call(this, t, e.html())), Z1(e, i, r, h);
			});
		if (
			p &&
			((e = (t = L1(i, a[0].ownerDocument, !1, a, h)).firstChild),
			1 === t.childNodes.length && (t = e),
			e || h)
		) {
			for (s = (n = A.map(M(t, "script"), R1)).length; l < p; l++)
				(o = t),
					l !== c &&
						((o = A.clone(o, !0, !0)), s) &&
						A.merge(n, M(o, "script")),
					r.call(a[l], o, l);
			if (s)
				for (
					d = n[n.length - 1].ownerDocument, A.map(n, q1), l = 0;
					l < s;
					l++
				)
					(o = n[l]),
						S1.test(o.type || "") &&
							!f.access(o, "globalEval") &&
							A.contains(d, o) &&
								...
								? A._evalUrl &&
								  ...
								  A._evalUrl(
										o.src,
										{
											nonce:
												o.nonce ||
												o.getAttribute("nonce"),
										},
										d
								  )
								: G(o.textContent.replace(F1, ""), o, d));
		}
		return a;
	}
	function N1(t, e, a) {
		for (var i, r = e ? A.filter(e, t) : t, h = 0; null != (i = r[h]); h++)
			a || 1 !== i.nodeType || A.cleanData(M(i)),
				i.parentNode &&
					(a && m1(i) && H1(M(i, "script")),
	...
	A.extend({
		...
		clone: function (t, e, a) {
			...
			if (
				...
				for (n = M(l), i = 0, r = (h = M(t)).length; i < r; i++)
					(s = h[i]),
						"input" === (d = (o = n[i]).nodeName.toLowerCase()) &&
						C1.test(s.type)
							? (o.checked = s.checked)
							: ("input" !== d && "textarea" !== d) ||
			...
			if (e)
				if (a)
					for (
						h = h || M(t), n = n || M(l), i = 0, r = h.length;
						i < r;
						i++
					)
						z1(h[i], n[i]);
			...
			return (
				0 < (n = M(l, "script")).length && H1(n, !p && M(t, "script")),
				l
			);
		},
		cleanData: function (t) {
			for (
				var e, a, i, r = A.event.special, h = 0;
				void 0 !== (a = t[h]);
				h++
			)
				if (d1(a)) {
		...
		A.fn.extend({
			...
			append: function () {
				return Z1(this, arguments, function (t) {
					(1 !== this.nodeType &&
						11 !== this.nodeType &&
						9 !== this.nodeType) ||
						B1(this, t).appendChild(t);
				});
			},
			prepend: function () {
				return Z1(this, arguments, function (t) {
					...
					(1 !== this.nodeType &&
						11 !== this.nodeType &&
						9 !== this.nodeType) ||
						(e = B1(this, t)).insertBefore(t, e.firstChild);
				});
			},
			before: function () {
				return Z1(this, arguments, function (t) {
			...
			empty: function () {
				for (var t, e = 0; null != (t = this[e]); e++)
					1 === t.nodeType &&
						(A.cleanData(M(t, !1)), (t.textContent = ""));
				return this;
			},
			clone: function (t, e) {
				return (
		...
		A.each(
			...
			function (t, n) {
				A.fn[t] = function (t) {
					for (
						var e, a = [], i = A(t), r = i.length - 1, h = 0;
						h <= r;
						h++
					)
						(e = h === r ? this : this.clone(!0)),
							A(i[h])[n](e),
							z.apply(a, e.get());
	...
	function j1(t, e, a) {
		...
		for (i in ((a = a.call(t)), e)) t.style[i] = r[i];
		return a;
	}
	var W1,
		U1,
		...
		Y1,
		d,
		Q1 = new RegExp("^(" + t + ")(?!px)[a-z%]+$", "i"),
		J1 = /^--/,
		te = new RegExp(M1.join("|"), "i");
	function ee(t, e, a) {
		var i,
			r = J1.test(e),
			h = t.style;
		return (
			(a = a || I1(t)) &&
				((i = a.getPropertyValue(e) || a[e]),
				"" !== (i = r ? i && (i.replace(tt, "$1") || void 0) : i) ||
					m1(t) ||
					(i = A.style(t, e)),
				!g.pixelBoxStyles()) &&
				Q1.test(i) &&
				...
				(t = h.minWidth),
				(e = h.maxWidth),
				(h.minWidth = h.maxWidth = h.width = i),
				(i = a.width),
				(h.width = r),
				(h.minWidth = t),
				(h.maxWidth = e)),
	...
	function ie() {
		...
		d &&
			...
			f1.appendChild(Y1).appendChild(d),
			(t = b.getComputedStyle(d)),
			(W1 = "1%" !== t.top),
			(K1 = 12 === re(t.marginLeft)),
			(d.style.right = "60%"),
			(X1 = 36 === re(t.right)),
			(U1 = 36 === re(t.width)),
			(d.style.position = "absolute"),
			(G1 = 12 === re(d.offsetWidth / 3)),
			f1.removeChild(Y1),
			(d = null));
	}
	function re(t) {
				...
				reliableTrDimensions: function () {
					...
					return (
						null == $1 &&
							...
							f1.appendChild(t).appendChild(e).appendChild(a),
							(a = b.getComputedStyle(e)),
							($1 =
	...
	function ve(t, e, a, i, r, h) {
		...
		for (; n < 4; n += 2)
			"margin" === a && (d += A.css(t, a + M1[n], !0, r)),
				i
					? ("content" === a &&
							(o -= A.css(t, "padding" + M1[n], !0, r)),
					  "margin" !== a &&
							(o -= A.css(t, "border" + M1[n] + "Width", !0, r)))
					: ((o += A.css(t, "padding" + M1[n], !0, r)),
					  "padding" !== a
							? (o += A.css(t, "border" + M1[n] + "Width", !0, r))
							: (s += A.css(
	...
	function ue(t, e, a) {
		...
		return (
			((!g.boxSizingReliable() && r) ||
				(!g.reliableTrDimensions() && x(t, "tr")) ||
				"auto" === n ||
				(!parseFloat(n) && "inline" === A.css(t, "display", !1, i))) &&
				t.getClientRects().length &&
				((r = "border-box" === A.css(t, "boxSizing", !1, i)),
				(h = s in t)) &&
				(n = t[s]),
			(n = parseFloat(n) || 0) +
				ve(t, e, a || (r ? "border" : "content"), h, i, n) +
				"px"
		);
	}
	function P(t, e, a, i, r) {
		return new P.prototype.init(t, e, a, i, r);
	}
	A.extend({
		cssHooks: {
			opacity: {
				get: function (t, e) {
					if (e) return "" === (e = ee(t, "opacity")) ? "1" : e;
				},
			},
		},
		cssNumber: {
		...
		style: function (t, e, a, i) {
			if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
				...
				if (
					(o || (e = oe(s)),
					(n = A.cssHooks[e] || A.cssHooks[s]),
					void 0 === a)
				)
					return n && "get" in n && void 0 !== (r = n.get(t, !1, i))
						? r
						: d[e];
				"string" == (h = typeof a) &&
					(r = g1.exec(a)) &&
					...
					null != a &&
						...
						("number" !== h ||
							o ||
							(a += (r && r[3]) || (A.cssNumber[s] ? "" : "px")),
						g.clearCloneStyle ||
							"" !== a ||
							0 !== e.indexOf("background") ||
							(d[e] = "inherit"),
						(n && "set" in n && void 0 === (a = n.set(t, a, i))) ||
							(o ? d.setProperty(e, a) : (d[e] = a)));
			}
		},
			...
			return (
				...
				"normal" ===
					(r =
						void 0 ===
						(r =
							(h = A.cssHooks[e] || A.cssHooks[h]) && "get" in h
								? h.get(t, !0, a)
								: r)
							? ee(t, e, i)
							: r) &&
					...
					(r = pe[e]),
				("" === a || a) &&
				((h = parseFloat(r)), !0 === a || isFinite(h))
					? h || 0
					: r
			);
		},
	}),
		A.each(["height", "width"], function (t, n) {
			A.cssHooks[n] = {
				get: function (t, e, a) {
					if (e)
						return !de.test(A.css(t, "display")) ||
							(t.getClientRects().length &&
				...
				set: function (t, e, a) {
					...
					return (
						...
						a &&
							(h = g1.exec(e)) &&
							"px" !== (h[3] || "px") &&
							((t.style[n] = e), (e = A.css(t, n))),
						ce(0, e, a)
					);
				},
			};
		}),
		(A.cssHooks.marginLeft = ae(g.reliableMarginLeft, function (t, e) {
			if (e)
				return (
					(parseFloat(ee(t, "marginLeft")) ||
						t.getBoundingClientRect().left -
							j1(t, { marginLeft: 0 }, function () {
								return t.getBoundingClientRect().left;
							})) + "px"
				);
		})),
		A.each({ margin: "", padding: "", border: "Width" }, function (r, h) {
			(A.cssHooks[r + h] = {
				expand: function (t) {
					for (
						var e = 0,
						...
						a[r + M1[e] + h] = i[e] || i[e - 2] || i[0];
					return a;
				},
			}),
				"margin" !== r && (A.cssHooks[r + h].set = ce);
		}),
		A.fn.extend({
			css: function (t, e) {
				return l(
					...
					function (t, e, a) {
						var i,
							...
							n = 0;
						if (Array.isArray(e)) {
							for (i = I1(t), r = e.length; n < r; n++)
								h[e[n]] = A.css(t, e[n], !1, i);
							return h;
						}
		...
		(((A.Tween = P).prototype = {
			...
			init: function (t, e, a, i, r, h) {
				(this.elem = t),
					...
					(this.end = i),
					(this.unit = h || (A.cssNumber[a] ? "" : "px"));
			},
			cur: function () {
				var t = P.propHooks[this.prop];
				return (t && t.get ? t : P.propHooks._default).get(this);
			},
			run: function (t) {
				var e,
				...
				return (
					...
					(a && a.set ? a : P.propHooks._default).set(this),
					this
				);
			},
	...
	function ye() {
		Me &&
			(!1 === C.hidden && b.requestAnimationFrame
				? b.requestAnimationFrame(ye)
				: b.setTimeout(ye, A.fx.interval),
			A.fx.tick());
	}
	function xe() {
		return (
	...
	function we(t, e) {
		...
		for (e = e ? 1 : 0; i < 4; i += 2 - e)
			r["margin" + (a = M1[i])] = r["padding" + a] = t;
		return e && (r.opacity = r.width = t), r;
	}
	function be(t, e, a) {
		for (
			var i,
				r = (O.tweeners[e] || []).concat(O.tweeners["*"]),
				h = 0,
				n = r.length;
			h < n;
			h++
		)
			if ((i = r[h].call(a, e, t))) return i;
	}
	function O(r, t, e) {
		var a,
			h,
			...
			d,
			l = 0,
			p = O.prefilters.length,
			c = A.Deferred().always(function () {
				delete v.elem;
			}),
			v = function () {
				if (h) return !1;
				for (
					...
					u.tweens[a].run(e);
				return (
					c.notifyWith(r, [u, e, t]),
					e < 1 && i
						? t
						: (i || c.notifyWith(r, [u, 1, 0]),
						  c.resolveWith(r, [u]),
						  !1)
				);
			},
			u = c.promise({
				...
				stop: function (t) {
					...
					if (!h) {
						for (h = !0; e < a; e++) u.tweens[e].run(1);
						t
							? (c.notifyWith(r, [u, 1, 0]),
							  c.resolveWith(r, [u, t]))
							: c.rejectWith(r, [u, t]);
					}
					return this;
		...
		for (i in M)
			if (
				((s = f[(n = D(i))]),
				(o = M[i]),
				Array.isArray(o) && ((s = o[1]), (o = M[i] = o[0])),
				i !== n && ((M[n] = o), delete M[i]),
				(d = A.cssHooks[n]) && "expand" in d)
			)
				for (i in ((o = d.expand(o)), delete M[n], o))
					i in M || ((M[i] = o[i]), (f[i] = s));
			else f[n] = s;
		for (; l < p; l++)
			if ((a = O.prefilters[l].call(u, r, g, u.opts)))
				return (
					m(a.stop) &&
						(A._queueHooks(u.elem, u.opts.queue).stop =
							a.stop.bind(a)),
					a
				);
		return (
			...
			A.fx.timer(A.extend(v, { elem: r, anim: u, queue: u.opts.queue })),
			u
		);
	}
	(A.Animation = A.extend(O, {
		tweeners: {
			"*": [
				function (t, e) {
					...
					return x1(a.elem, t, g1.exec(e), a), a;
				},
			],
		},
		tweener: function (t, e) {
			for (
				var a,
					i = 0,
					r = (t = m(t) ? ((e = t), ["*"]) : t.match(E)).length;
				i < r;
				i++
			)
				(a = t[i]),
					(O.tweeners[a] = O.tweeners[a] || []),
					O.tweeners[a].unshift(e);
		},
		prefilters: [
			function (t, e, a) {
				var i,
					...
					g = f.get(t, "fxshow");
				for (i in (a.queue ||
					(null == (n = A._queueHooks(t, "fx")).unqueued &&
						((n.unqueued = 0),
						(s = n.empty.fire),
					...
					p.always(function () {
						p.always(function () {
							n.unqueued--,
								A.queue(t, "fx").length || n.empty.fire();
						});
					})),
				e))
					if (((r = e[i]), fe.test(r))) {
						...
						c[i] = (g && g[i]) || A.style(t, i);
					}
				if ((o = !A.isEmptyObject(e)) || !A.isEmptyObject(c))
					for (i in (l &&
						1 === t.nodeType &&
		...
		A.fn.extend({
			fadeTo: function (t, e, a, i) {
				return this.filter(u1)
					.css("opacity", 0)
					.show()
					.end()
					.animate({ opacity: e }, t, a, i);
			},
			animate: function (e, t, a, i) {
				function r() {
					var t = O(this, A.extend({}, e), n);
					(h || f.get(this, "finish")) && t.stop(!0);
				}
				var h = A.isEmptyObject(e),
					n = A.speed(t, a, i);
				return (
					(r.finish = r),
					h || !1 === n.queue ? this.each(r) : this.queue(n.queue, r)
				);
			},
			stop: function (r, t, h) {
				function n(t) {
				...
				return (
					"string" != typeof r && ((h = t), (t = r), (r = void 0)),
					t && this.queue(r || "fx", []),
					this.each(function () {
						var t = !0,
							...
							a = A.timers,
							i = f.get(this);
						if (e) i[e] && i[e].stop && n(i[e]);
						else
							for (e in i)
								i[e] && i[e].stop && me.test(e) && n(i[e]);
						for (e = a.length; e--; )
							a[e].elem !== this ||
								(null != r && a[e].queue !== r) ||
								(a[e].anim.stop(h), (t = !1), a.splice(e, 1));
						(!t && h) || A.dequeue(this, r);
					})
				);
			},
			finish: function (n) {
		...
		(A.fx.tick = function () {
			var t,
				e = 0,
				a = A.timers;
			for (ge = Date.now(); e < a.length; e++)
				(t = a[e])() || a[e] !== t || a.splice(e--, 1);
			a.length || A.fx.stop(), (ge = void 0);
		}),
		...
		(n.type = "checkbox"),
		(g.checkOn = "" !== n.value),
		(g.optSelected = h.selected),
		((n = C.createElement("input")).value = "t"),
		(n.type = "radio"),
		(g.radioValue = "t" === n.value);
	var Ce,
		Ae = A.expr.attrHandle,
		Se =
			(A.fn.extend({
				attr: function (t, e) {
					return l(this, A.attr, t, e, 1 < arguments.length);
				},
			...
			A.extend({
				...
				removeAttr: function (t, e) {
					var a,
						...
						r = e && e.match(E);
					if (r && 1 === t.nodeType)
						for (; (a = r[i++]); ) t.removeAttribute(a);
				},
			}),
			(Ce = {
				set: function (t, e, a) {
					return (
						!1 === e ? A.removeAttr(t, a) : t.setAttribute(a, a), a
					);
				},
			}),
			A.each(A.expr.match.bool.source.match(/\w+/g), function (t, e) {
				var n = Ae[e] || A.find.attr;
				Ae[e] = function (t, e, a) {
					var i,
						r,
						h = e.toLowerCase();
	...
	A.fn.extend({
		prop: function (t, e) {
			return l(this, A.prop, t, e, 1 < arguments.length);
		},
			...
			prop: function (t, e, a) {
				...
				if (3 !== h && 8 !== h && 2 !== h)
					return (
						...
						void 0 !== a
							? r && "set" in r && void 0 !== (i = r.set(t, a, e))
								? i
								: (t[e] = a)
		...
		A.fn.extend({
			addClass: function (e) {
				...
				return m(e)
					? this.each(function (t) {
							A(this).addClass(e.call(this, t, Le(this)));
					  })
					: (t = ke(e)).length
					? this.each(function () {
							if (
								((i = Le(this)),
								(a = 1 === this.nodeType && " " + _e(i) + " "))
							) {
			...
			removeClass: function (e) {
				...
				return m(e)
					? this.each(function (t) {
							A(this).removeClass(e.call(this, t, Le(this)));
					  })
					: arguments.length
					? (t = ke(e)).length
						? this.each(function () {
					...
					return arguments.length
						? ((i = m(e)),
						  this.each(function (t) {
								1 === this.nodeType &&
									(null ==
									(t = i ? e.call(this, t, A(this).val()) : e)
										? (t = "")
										: "number" == typeof t
										? (t += "")
										: Array.isArray(t) &&
						...
						? (a =
								A.valHooks[r.type] ||
								A.valHooks[r.nodeName.toLowerCase()]) &&
						  "get" in a &&
					...
					select: {
							...
							for (
								...
								if (
									...
									(!e.parentNode.disabled ||
										!x(e.parentNode, "optgroup"))
								) {
									if (((e = A(e).val()), r)) return e;
									h.push(e);
								}
							return h;
						},
						set: function (t, e) {
							for (
								...
								((i = r[n]).selected =
									-1 <
									A.inArray(A.valHooks.option.get(i), h)) &&
									(a = !0);
			...
			(A.extend(A.event, {
				trigger: function (t, e, a, i) {
					var r,
						...
						l,
						p = [a || C],
						c = I.call(t, "type") ? t.type : t,
						v = I.call(t, "namespace")
							? t.namespace.split(".")
							: [],
						u = (l = h = a = a || C);
					if (
						3 !== a.nodeType &&
						8 !== a.nodeType &&
						!Oe.test(c + A.event.triggered) &&
						(-1 < c.indexOf(".") &&
							((c = (v = c.split(".")).shift()), v.sort()),
						(s = c.indexOf(":") < 0 && "on" + c),
						((t = t[A.expando]
							? t
							: new A.Event(
						...
						(d = A.event.special[c] || {}),
						i || !d.trigger || !1 !== d.trigger.apply(a, e))
					) {
						if (!i && !d.noBubble && !B(a)) {
							for (
								n = d.delegateType || c,
									Oe.test(n + c) || (u = u.parentNode);
								u;
								u = u.parentNode
							)
								p.push(u), (h = u);
							h === (a.ownerDocument || C) &&
								p.push(h.defaultView || h.parentWindow || b);
						}
						for (r = 0; (u = p[r++]) && !t.isPropagationStopped(); )
							(l = u),
								(t.type = 1 < r ? n : d.bindType || c),
								(o =
									(f.get(u, "events") || Object.create(null))[
										t.type
									] && f.get(u, "handle")) && o.apply(u, e),
								(o = s && u[s]) &&
									o.apply &&
									d1(u) &&
							...
							i ||
								...
								(s &&
									...
									t.isPropagationStopped() &&
										l.addEventListener(c, Ve),
									a[c](),
									t.isPropagationStopped() &&
										l.removeEventListener(c, Ve),
		...
		if (Array.isArray(t) || (t.jquery && !A.isPlainObject(t)))
			...
			for (i in t)
				!(function a(i, t, r, h) {
					...
					else if (r || "object" !== X(t)) h(i, t);
					else for (var e in t) a(i + "[" + e + "]", t[e], r, h);
				})(i, t[i], e, a);
		return r.join("&");
	}),
		A.fn.extend({
		...
		function o(t) {
			...
			return (
				...
				A.each(e[t] || [], function (t, e) {
					e = e(i, r, h);
					return "string" != typeof e || s || n[e]
						? s
							? !(a = e)
							: void 0
						: (i.dataTypes.unshift(e), o(e), !1);
				}),
				a
			);
		}
		return o(i.dataTypes[0]) || (!n["*"] && o("*"));
	}
	function Qe(t, e) {
		var a,
			i,
			r = A.ajaxSettings.flatOptions || {};
		for (a in e) void 0 !== e[a] && ((r[a] ? t : (i = i || {}))[a] = e[a]);
		...
		A.extend({
			...
			ajax: function (t, e) {
				...
				var o,
					...
					u = A.ajaxSetup({}, (e = e || {})),
					g = u.context || u,
					M = u.context && (g.nodeType || g.jquery) ? A(g) : A.event,
					f = A.Deferred(),
					...
					x = {
						...
						statusCode: function (t) {
							if (t)
								...
								else for (var e in t) y[e] = [y[e], t[e]];
							return this;
						},
						abort: function (t) {
							t = t || s;
							return o && o.abort(t), w(0, t), this;
						},
					};
				if (
					(f.promise(x),
					(u.url = ((t || u.url || Ee.href) + "").replace(
						We,
						Ee.protocol + "//"
					)),
					(u.type = e.method || e.type || u.method || u.type),
					(u.dataTypes = (u.dataType || "*")
						.toLowerCase()
						.match(E) || [""]),
					null == u.crossDomain)
				) {
				...
				if (
					(u.data &&
						...
						(u.data = A.param(u.data, u.traditional)),
					Ye(Ue, u, e, x),
					!c)
				) {
					for (i in ((v = A.event && u.global) &&
						0 == A.active++ &&
						A.event.trigger("ajaxStart"),
					(u.type = u.type.toUpperCase()),
					(u.hasContent = !je.test(u.type)),
					(d = u.url.replace(Ze, "")),
					u.hasContent
						? u.data &&
						  u.processData &&
						  ...
						  (u.data = u.data.replace(ze, "+"))
						: ((r = u.url.slice(d.length)),
						  u.data &&
					...
					u.ifModified &&
						...
						A.etag[d]) &&
						x.setRequestHeader("If-None-Match", A.etag[d]),
					...
					c ||
						...
						a &&
							(n = (function (t, e, a) {
								...
								if (h) return h !== o[0] && o.unshift(h), a[h];
							})(u, x, a)),
						!i &&
							-1 < A.inArray("script", u.dataTypes) &&
							A.inArray("json", u.dataTypes) < 0 &&
						...
						(n = (function (t, e, a, i) {
							...
							if (l[1])
								for (n in t.converters)
									d[n.toLowerCase()] = t.converters[n];
							for (h = l.shift(); h; )
								if (
									(t.responseFields[h] &&
										(a[t.responseFields[h]] = e),
									!o &&
										i &&
										t.dataFilter &&
						...
						(x.statusText = (e || s) + ""),
						i
							? f.resolveWith(g, [r, s, x])
							: f.rejectWith(g, [x, s, h]),
						x.statusCode(y),
						(y = void 0),
						v &&
	...
	var Je = { 0: 200, 1223: 204 },
		t2 = A.ajaxSettings.xhr();
	(g.cors = !!t2 && "withCredentials" in t2),
		(g.ajax = t2 = !!t2),
		A.ajaxTransport(function (r) {
			var h, n;
			if (g.cors || (t2 && !r.crossDomain))
				return {
					send: function (t, e) {
						var a,
							i = r.xhr();
						...
						(h = function (t) {
							...
							(i.onload = h()),
							(n = i.onerror = i.ontimeout = h("error")),
							void 0 !== i.onabort
								? (i.onabort = n)
		...
		i2 =
			(A.ajaxSetup({
				...
				jsonpCallback: function () {
					var t = e2.pop() || A.expando + "_" + De.guid++;
					return (this[t] = !0), t;
				},
			}),
				...
				if (n || "jsonp" === t.dataTypes[0])
					return (
						...
						(t.converters["script json"] = function () {
							return h || A.error(i + " was not called"), h[0];
						}),
						(t.dataTypes[0] = "json"),
						(r = b[i]),
						(b[i] = function () {
						...
						a.always(function () {
							void 0 === r ? A(b).removeProp(i) : (b[i] = r),
								t[i] &&
			...
			(A.fn.load = function (t, e, a) {
				var i,
					...
					s = t.indexOf(" ");
				return (
					-1 < s && ((i = _e(t.slice(s))), (t = t.slice(0, s))),
					m(e)
						? ((a = e), (e = void 0))
				...
				setOffset: function (t, e, a) {
					...
					"static" === s && (t.style.position = "relative"),
						...
						(s =
							("absolute" === s || "fixed" === s) &&
							-1 < (i + n).indexOf("auto")
								? ((r = (s = o.position()).top), s.left)
								: ((r = parseFloat(i) || 0),
								  parseFloat(n) || 0)),
						null !=
							(e = m(e) ? e.call(t, a, A.extend({}, h)) : e)
								.top && (d.top = e.top - h.top + r),
						null != e.left && (d.left = e.left - h.left + s),
					...
					if (this[0]) {
						...
						if ("fixed" === A.css(i, "position"))
							...
							for (
								e = this.offset(),
									a = i.ownerDocument,
									t = i.offsetParent || a.documentElement;
								t &&
			...
			A.each(["top", "left"], function (t, a) {
				A.cssHooks[a] = ae(g.pixelPosition, function (t, e) {
					if (e)
						return (
							(e = ee(t, a)),
							Q1.test(e) ? A(t).position()[a] + "px" : e
						);
				});
			}),
			A.each({ Height: "height", Width: "width" }, function (n, s) {
				A.each(
					{ padding: "inner" + n, content: s, "": "outer" + n },
					function (i, h) {
						A.fn[h] = function (t, e) {
							var a =
									arguments.length &&
	...
	return (
		(A.noConflict = function (t) {
			return (
				b.$ === A && (b.$ = h2),
				t && b.jQuery === A && (b.jQuery = r2),
				A
			);
		}),
		void 0 === F && (b.jQuery = b.$ = A),
		A
	);
}),
	(function (t, e) {
		...
		const d = (t, e = [], a = t) => ("function" == typeof t ? t(...e) : a),
			U = (a, i, t = !0) => {
				if (t) {
					t =
						((t) => {
							if (!t) return 0;
							let { transitionDuration: e, transitionDelay: a } =
								window.getComputedStyle(t);
							var t = Number.parseFloat(e),
								i = Number.parseFloat(a);
							return t || i
								? ((e = e.split(",")[0]),
								  (a = a.split(",")[0]),
								  (Number.parseFloat(e) +
					...
					const r = ({ target: t }) => {
						t === i &&
							((e = !0), i.removeEventListener(R, r), d(a));
					};
					i.addEventListener(R, r),
						setTimeout(() => {
							e || z(i);
						}, t);
				} else d(a);
		...
		function it(t, e, a = null) {
			return Object.values(t).find(
				(t) => t.callable === e && t.delegationSelector === a
			);
		}
		function rt(t, e, a) {
			var i = "string" == typeof e,
				e = (!i && e) || a;
			let r = st(t);
			return [i, e, (r = tt.has(r) ? r : t)];
		}
		function ht(i, r, h, n, s) {
					...
					: ((u = et(e, r.replace(X, ""))),
					  ((r = t
							...
							: ((d = i),
							  ...
							  function t(e) {
									return (
										ot(e, { delegateTarget: d }),
										t.oneOff && g.off(d, e.type, l),
										l.apply(d, [e])
									);
							  })).delegationSelector = t ? h : null),
					  (r.callable = e),
					  (r.oneOff = s),
					  (n[(r.uidEvent = u)] = r),
					  i.addEventListener(a, r, t));
			}
		}
		function nt(t, e, a, i, r) {
			i = it(e[a], i, r);
			i &&
				(t.removeEventListener(a, i, Boolean(r)),
				delete e[a][i.uidEvent]);
		}
		function st(t) {
			return (t = t.replace($, "")), J[t] || t;
		}
		const g = {
			on(t, e, a, i) {
				ht(t, e, a, i, !1);
				...
				if ("string" == typeof e && t) {
					...
					if (void 0 !== n)
						return Object.keys(l).length
							? void nt(t, d, s, n, i ? a : null)
							: void 0;
					if (p)
						for (const x of Object.keys(d)) {
							v = c = m = f = M = g = u = void 0;
							var c,
								v,
								u = t,
								g = d,
					...
					for ([r, h] of Object.entries(l)) {
						var y = r.replace(K, "");
						(o && !e.includes(y)) ||
							nt(t, d, s, h.callable, h.delegationSelector);
					}
				}
			},
			trigger(t, e, a) {
				...
				e !== st(e) &&
					...
					((r = i.Event(e, a)),
					i(t).trigger(r),
					(h = !r.isPropagationStopped()),
					(n = !r.isImmediatePropagationStopped()),
					(s = r.isDefaultPrevented()));
				i = ot(new Event(e, { bubbles: h, cancelable: !0 }), a);
				return (
					s && i.preventDefault(),
					n && t.dispatchEvent(i),
		...
		const l = {
			...
			getDataAttributes(e) {
				...
				for (const i of Object.keys(e.dataset).filter(
					...
					let t = i.replace(/^bs/, "");
					a[(t = t.charAt(0).toLowerCase() + t.slice(1, t.length))] =
						dt(e.dataset[i]);
				}
				return a;
			},
			getDataAttribute(t, e) {
				return dt(t.getAttribute("data-bs-" + lt(e)));
			},
		};
		class pt {
			static get Default() {
			...
			_mergeConfigObj(t, e) {
				var a = h(e) ? l.getDataAttribute(e, "config") : {};
				return {
					...this.constructor.Default,
					...("object" == typeof a ? a : {}),
					...(h(e) ? l.getDataAttributes(e) : {}),
					...("object" == typeof t ? t : {}),
				};
			}
			...
			p = {
				...
				focusableChildren(t) {
					var e = [
						...
						.join(",");
					return this.find(e, t).filter((t) => !s(t) && n(t));
				},
		...
		var vt = (e, a = "hide") => {
			...
			const i = e.NAME;
			g.on(document, t, `[data-bs-dismiss="${i}"]`, function (t) {
				["A", "AREA"].includes(this.tagName) && t.preventDefault(),
					s(this) ||
						((t =
							p.getElementFromSelector(this) ||
							this.closest("." + i)),
		...
		class ut extends e {
			...
			static jQueryInterface(e) {
				return this.each(function () {
					var t = ut.getOrCreateInstance(this);
					if ("string" == typeof e) {
						if (
							void 0 === t[e] ||
							e.startsWith("_") ||
		...
		vt(ut, "close"), t(ut);
		const gt = '[data-bs-toggle="button"]';
		class Mt extends e {
			static get NAME() {
				return "button";
			}
		...
		g.on(document, "click.bs.button.data-api", gt, (t) => {
			t.preventDefault();
			t = t.target.closest(gt);
		...
		class yt extends pt {
			...
			_initEvents() {
				this._supportPointerEvents
					? (g.on(this._element, "pointerdown.bs.swipe", (t) =>
							this._start(t)
					  ),
					  g.on(this._element, "pointerup.bs.swipe", (t) =>
							this._end(t)
					  ),
					  this._element.classList.add("pointer-event"))
					: (g.on(this._element, "touchstart.bs.swipe", (t) =>
							this._start(t)
					  ),
					  g.on(this._element, "touchmove.bs.swipe", (t) =>
							this._move(t)
					  ),
					  g.on(this._element, "touchend.bs.swipe", (t) =>
							this._end(t)
					  ));
			}
		...
		const Ct = "carousel",
			...
			Ht = ".carousel-item";
		St, Ht;
		const _t = { ArrowLeft: wt, ArrowRight: u },
			Lt = {
				interval: 5e3,
				keyboard: !0,
				pause: "hover",
		...
		class Vt extends e {
			...
			_maybeEnableCycle() {
				this._config.ride &&
					(this._isSliding
						? g.one(this._element, bt, () => this.cycle())
						: this.cycle());
			}
			to(t) {
				var e,
				...
				t > a.length - 1 ||
					t < 0 ||
					(this._isSliding
						? g.one(this._element, bt, () => this.to(t))
						: (e = this._getItemIndex(this._getActive())) !== t &&
						  ((e = e < t ? xt : v), this._slide(e, a[t])));
			}
			dispose() {
			...
			_addEventListeners() {
				this._config.keyboard &&
					g.on(this._element, "keydown.bs.carousel", (t) =>
						this._keydown(t)
					),
			...
			_addTouchEventListeners() {
				for (const e of p.find(".carousel-item img", this._element))
					g.on(e, "dragstart.bs.carousel", (t) => t.preventDefault());
				var t = {
					leftCallback: () => this._slide(this._directionToOrder(u)),
					rightCallback: () =>
						this._slide(this._directionToOrder(wt)),
					endCallback: () => {
						"hover" === this._config.pause &&
							(this.pause(),
							this.touchTimeout &&
			...
			_slide(e, t = null) {
				if (!this._isSliding) {
					...
					var a = e === xt;
					const r = t || G(this._getItems(), i, a, this._config.wrap);
					if (r !== i) {
						const h = this._getItemIndex(r),
							n = (t) =>
						...
						if (!t.defaultPrevented && i && r) {
							...
							this._queueCallback(
								() => {
									r.classList.remove(s, o),
										r.classList.add(At),
										i.classList.remove(At, o, s),
										(this._isSliding = !1),
										n(bt);
								},
								i,
			...
			_getItems() {
				return p.find(Ht, this._element);
			}
			_clearInterval() {
				this._interval &&
			...
			_directionToOrder(t) {
				return o() ? (t === u ? v : xt) : t === u ? xt : v;
			}
			_orderToDirection(t) {
				return o() ? (t === v ? u : wt) : t === v ? wt : u;
			}
			static jQueryInterface(e) {
				return this.each(function () {
					var t = Vt.getOrCreateInstance(this, e);
		...
		g.on(
			...
			function (t) {
				var e = p.getElementFromSelector(this);
				e &&
					e.classList.contains(Ct) &&
					(t.preventDefault(),
					(t = Vt.getOrCreateInstance(e)),
			...
			g.on(window, "load.bs.carousel.data-api", () => {
				for (const t of p.find('[data-bs-ride="carousel"]'))
		...
		class Ft extends e {
			constructor(t, e) {
				super(t, e),
					...
					(this._triggerArray = []);
				for (const r of p.find(Dt)) {
					var a = p.getSelectorFromElement(r),
						i = p.find(a).filter((t) => t === this._element);
					null !== a && i.length && this._triggerArray.push(r);
				}
			...
			show() {
				if (!this._isTransitioning && !this._isShown()) {
					...
					if (
						...
						var e = g.trigger(this._element, "show.bs.collapse");
						if (!e.defaultPrevented) {
							...
							e = "scroll" + (a[0].toUpperCase() + a.slice(1));
							this._queueCallback(
								() => {
									(this._isTransitioning = !1),
										this._element.classList.remove(Et),
										this._element.classList.add(M, Tt),
			...
			hide() {
				if (!this._isTransitioning && this._isShown()) {
					var t = g.trigger(this._element, "hide.bs.collapse");
					if (!t.defaultPrevented) {
						...
						(this._element.style[t] =
							...
							I(this._element),
							this._element.classList.add(Et),
							this._element.classList.remove(M, Tt);
						for (const a of this._triggerArray) {
							var e = p.getElementFromSelector(a);
							e &&
								!this._isShown(e) &&
			...
			_addAriaAndCollapsedClass(t, e) {
				if (t.length)
					for (const a of t)
						a.classList.toggle("collapsed", !e),
			...
			static jQueryInterface(e) {
				...
				return (
					"string" == typeof e &&
						...
						(a.toggle = !1),
					this.each(function () {
						var t = Ft.getOrCreateInstance(this, a);
						if ("string" == typeof e) {
							if (void 0 === t[e])
								throw new TypeError(`No method named "${e}"`);
							t[e]();
		...
		g.on(document, "click.bs.collapse.data-api", Dt, function (t) {
			("A" === t.target.tagName ||
				(t.delegateTarget && "A" === t.delegateTarget.tagName)) &&
				t.preventDefault();
			for (const e of p.getMultipleElementsFromSelector(this))
		...
		var _ = "top",
			...
			It = T.reduce(function (t, e) {
				return t.concat([e + "-" + E, e + "-" + Rt]);
			}, []),
			jt = [].concat(T, [Bt]).reduce(function (t, e) {
				return t.concat([e, e + "-" + E, e + "-" + Rt]);
			}, []),
			c = "beforeRead",
			Wt = "afterRead",
			Ut = "beforeMain",
			...
			Xt = "beforeWrite",
			$t = "afterWrite",
			Kt = [c, "read", Wt, Ut, "main", Gt, Xt, "write", $t];
		function f(t) {
		...
		function Yt(t) {
			return (
				...
				(t instanceof y(t).ShadowRoot || t instanceof ShadowRoot)
			);
		}
		var Qt = {
			name: "applyStyles",
					...
					function () {
						Object.keys(i.elements).forEach(function (t) {
							var e = i.elements[t],
								a = i.attributes[t] || {},
								t = Object.keys(
									(i.styles.hasOwnProperty(t) ? i.styles : r)[
										t
									]
								).reduce(function (t, e) {
									return (t[e] = ""), t;
		...
		function i1(t, e, a) {
			...
			e &&
				x(t) &&
				((r = (0 < t.offsetWidth && t1(i.width) / t.offsetWidth) || 1),
				(h =
					(0 < t.offsetHeight && t1(i.height) / t.offsetHeight) ||
					1));
			(e = (m(t) ? y(t) : window).visualViewport),
				(t = !a1() && a),
				(a = (i.left + (t && e ? e.offsetLeft : 0)) / r),
				(t = (i.top + (t && e ? e.offsetTop : 0)) / h),
				(e = i.width / r),
				(r = i.height / h);
			return {
				width: e,
		...
		function b(t) {
			return (
				(m(t) ? t.ownerDocument : t.document) || window.document
			).documentElement;
		}
		function n1(t) {
			return "html" === f(t)
		...
		function o1(t) {
			...
			return (
				((!i ||
					("html" !== f(i) &&
						("body" !== f(i) || "static" !== w(i).position))) &&
					(i ||
						(function (t) {
							var e = /firefox/i.test(e1()),
								a = /Trident/i.test(e1());
							if (!a || !x(t) || "fixed" !== w(t).position) {
								var i = n1(t);
								for (
									Yt(i) && (i = i.host);
									x(i) && ["html", "body"].indexOf(f(i)) < 0;
		...
		var u1 = {
			...
			fn: function (t) {
				var e,
					...
					t = t.options,
					s = h.elements.arrow,
					o = h.modifiersData.popperOffsets,
					d = d1((l = D(h.placement))),
					l = 0 <= [V, k].indexOf(l) ? "height" : "width";
				s &&
					o &&
					((t = t.padding),
					(a = h),
					...
					(r = a[r]),
					(a = s - t[l] - a[i]),
					(r = l1(r, (i = s / 2 - t[l] / 2 + (e / 2 - o / 2)), a)),
					(h.modifiersData[n] =
						(((s = {})[d] = r), (s.centerOffset = r - i), s)));
			},
			effect: function (t) {
				var e = t.state;
				null !=
		...
		function f1(t) {
			var e,
				...
				c = n.y,
				c = void 0 === c ? 0 : c,
				v = "function" == typeof l ? l({ x: p, y: c }) : { x: p, y: c },
				v = ((p = v.x), (c = v.y), n.hasOwnProperty("x")),
				...
				f =
					(d &&
						...
						(e = "clientWidth"),
						(m = o1(a)) === y(a) &&
							"static" !== w((m = b(a))).position &&
							"absolute" === s &&
							((f = "scrollHeight"), (e = "scrollWidth")),
						(r !== _ && ((r !== V && r !== k) || h !== Rt)) ||
							((g = L),
							(c =
								(c -
									((t && m === M && M.visualViewport
				...
				m =
					!0 === l
						? ((r = { x: p, y: c }),
						  ...
						  (t = r.x),
						  (r = r.y),
						  (h = h.devicePixelRatio || 1),
						  { x: t1(t * h) / h || 0, y: t1(r * h) / h || 0 })
						: { x: p, y: c };
			return (
				(p = m.x),
				(c = m.y),
		...
		var x1 = {
				...
				effect: function (t) {
					var e = t.state,
						...
						r = void 0 === i || i,
						h = void 0 === (i = t.resize) || i,
						n = y(e.elements.popper),
						s = [].concat(
					...
					return (
						r &&
							s.forEach(function (t) {
								t.addEventListener("scroll", a.update, y1);
							}),
						h && n.addEventListener("resize", a.update, y1),
						function () {
							r &&
								s.forEach(function (t) {
		...
		function H1(t) {
			return i1(b(t)).left + S1(t).scrollLeft;
		}
		function _1(t) {
			var t = w(t),
				e = t.overflow,
		...
		function L1(t, e) {
			void 0 === e && (e = []);
			var a = (function t(e) {
					return 0 <= ["html", "body", "#document"].indexOf(f(e))
				...
				i = y(a),
				i = t ? [i].concat(i.visualViewport || [], _1(a) ? a : []) : a,
				a = e.concat(i);
			return t ? a : a.concat(L1(n1(i)));
		}
		function k1(t) {
			...
			return e === zt
				? k1(
						...
						n &&
							...
							(s = n.height),
							(h = a1()) || (!h && "fixed" === r)) &&
							((d = n.offsetLeft), (l = n.offsetTop)),
						{ width: o, height: s, x: d + H1(i), y: l })
				  )
				: m(e)
				? (((r = i1((h = e), !1, "fixed" === (r = a))).top =
						r.top + h.clientTop),
				  (r.left = r.left + h.clientLeft),
				  (r.bottom = r.top + h.clientHeight),
				  (r.right = r.left + h.clientWidth),
				  (r.width = h.clientWidth),
				  (r.height = h.clientHeight),
				  (r.x = r.left),
				  (r.y = r.top),
				  r)
				: k1(
						...
						(s = -s.scrollTop),
						"rtl" === w(d || o).direction &&
							(n += H(o.clientWidth, d ? d.clientWidth : 0) - i),
						{ width: i, height: l, x: n, y: s })
				  );
			var i, r, h, n, s, o, d, l;
		}
		function T1(a, t, e, i) {
		...
		function E1(t) {
			var e,
				...
				r = t ? D(t) : null,
				t = t ? g1(t) : null,
				h = a.x + a.width / 2 - i.width / 2,
				n = a.y + a.height / 2 - i.height / 2;
			switch (r) {
				case _:
					e = { x: h, y: a.y - i.height };
					break;
				case L:
					e = { x: h, y: a.y + a.height };
					break;
				case k:
					e = { x: a.x + a.width, y: n };
					break;
		...
		function D1(t, e) {
			var i,
				...
				e = e.padding,
				e = void 0 === e ? 0 : e,
				e = c1("number" != typeof e ? e : v1(e, T)),
				d = t.rects.popper,
				o = t.elements[o ? (s === Zt ? Nt : Zt) : s],
				o = T1(
					m(o) ? o : o.contextElement || b(t.elements.popper),
					h,
					n,
					r
				),
				h = i1(t.elements.reference),
				n = E1({
					reference: h,
					element: d,
					strategy: "absolute",
				...
				r = k1(Object.assign({}, d, n)),
				d = s === Zt ? r : h,
				l = {
					top: o.top - d.top + e.top,
					bottom: d.bottom - o.bottom + e.bottom,
					left: o.left - d.left + e.left,
					right: d.right - o.right + e.right,
				},
			...
			return (
				s === Zt &&
					...
					Object.keys(l).forEach(function (t) {
						var e = 0 <= [k, L].indexOf(t) ? 1 : -1,
							a = 0 <= [_, L].indexOf(t) ? "y" : "x";
						l[t] += i[a] * e;
					})),
				l
			);
				...
				if (!p.modifiersData[t]._skip) {
					for (
						var a = e.mainAxis,
							...
							a =
								...
								(e === n || !g
									...
									? []
									: ((e = b1(a)), [A1(a), e, A1(e)])),
							s = [n].concat(a).reduce(function (t, e) {
								return t.concat(
									D(e) === Bt
										? ((a = p),
										  (i = (t = t =
						...
						var x = s[y],
							...
							C = C ? (b ? k : V) : b ? L : _,
							b = (o[A] > d[A] && (C = b1(C)), b1(C)),
							A = [];
						if (
							(i && A.push(S[w] <= 0),
							r && A.push(S[C] <= 0, S[b] <= 0),
							A.every(function (t) {
								return t;
							}))
						) {
		...
		function F1(e) {
			return [_, k, L, V].some(function (t) {
				return 0 <= e[t];
			});
		}
		var B1 = {
			...
			fn: function (t) {
				var e = t.state,
					...
					h = D1(e, { elementContext: "reference" }),
					n = D1(e, { altBoundary: !0 }),
					h = O1(h, a),
					a = O1(n, i, r),
					n = F1(h),
					i = F1(a);
		...
		var z1 = {
			...
			fn: function (t) {
				var e,
					...
					p = t.options,
					t = t.name,
					c = void 0 === (c = p.mainAxis) || c,
					v = void 0 !== (v = p.altAxis) && v,
					u = p.boundary,
					g = p.rootBoundary,
					M = p.altBoundary,
					f = p.padding,
					m = void 0 === (m = p.tether) || m,
				...
				w &&
					(c &&
						...
						(f = f === E ? -C[c] : -b[c]),
						(h = l.elements.arrow),
						(h = m && h ? r1(h) : { width: 0, height: 0 }),
						(a = (i = l.modifiersData["arrow#persistent"]
							? l.modifiersData["arrow#persistent"].padding
							: p1())[a]),
						(i = i[d]),
						(d = l1(0, b[c], h[c])),
						(h = M
							? b[c] / 2 - e - d - a - p.mainAxis
							: r - d - a - p.mainAxis),
						(r = M
							? -b[c] / 2 + e + d + i + p.mainAxis
							: f + d + i + p.mainAxis),
						(M = (a = l.elements.arrow && o1(l.elements.arrow))
							? "y" === y
								? a.clientTop || 0
								: a.clientLeft || 0
							: 0),
					...
					v &&
						...
						(c = a - u["x" === y ? L : k]),
						(h = -1 !== [_, V].indexOf(g)),
						(M = null != (e = null == A ? void 0 : A[x]) ? e : 0),
						(n = h ? r : a - b[i] - C[i] - M + p.altAxis),
						(f = h ? a + b[i] + C[i] - M - p.altAxis : c),
						(s =
							m && h
								? ((o = l1((o = n), a, (d = f))), d < o ? d : o)
								: l1(m ? n : r, a, m ? f : c)),
						(w[x] = s),
						(S[x] = s - a)),
					(l.modifiersData[t] = S));
		...
		function Z1(t, e, a) {
			...
			var i = x(e),
				r =
					...
					(h = t1(n.width) / r.offsetWidth || 1),
					(n = t1(n.height) / r.offsetHeight || 1),
					1 !== h || 1 !== n),
				h = b(e),
				n = i1(t, r, a),
					...
					(("body" === f(e) && !_1(h)) ||
						(t =
							(i = e) !== y(i) && x(i)
								...
								: S1(i)),
					x(e)
						? (((s = i1(e, !0)).x += e.clientLeft),
						  (s.y += e.clientTop))
						: h && (s.x = H1(h))),
				{
					x: n.left + t.scrollLeft - s.x,
					y: n.top + t.scrollTop - s.y,
					width: n.width,
					height: n.height,
				}
			);
		...
		var I1 = { placement: "bottom", modifiers: [], strategy: "absolute" };
		function j1() {
				...
				var a,
					...
					d = {
						...
						setOptions: function (t) {
							var a,
								e,
								t = "function" == typeof t ? t(n.options) : t,
								t =
									(l(),
									...
									(t = [].concat(p, n.options.modifiers)),
							...
							return (
								(n.orderedModifiers = t.filter(function (t) {
									return t.enabled;
								})),
							...
							if (!o) {
								...
								if (j1(e, t)) {
									(n.rects = {
										...
										n.orderedModifiers.forEach(function (
											t
										) {
											return (n.modifiersData[t.name] =
												Object.assign({}, t.data));
										});
									for (
										var a, i, r, h = 0;
										h < n.orderedModifiers.length;
										h++
									)
										!0 === n.reset
											? ((n.reset = !1), (h = -1))
											: ((a = (r = n.orderedModifiers[h])
													.fn),
											  (i = r.options),
											  (r = r.name),
											  "function" == typeof a &&
				...
				return (
					j1(i, r) &&
						d.setOptions(e).then(function (t) {
							!o && e.onFirstUpdate && e.onFirstUpdate(t);
						}),
					d
				);
				function l() {
		...
		var U1 = W1({ defaultModifiers: [x1, q1, m1, Qt, R1, P1, z1, u1, B1] });
		const G1 = Object.freeze(
			...
			X1 = "dropdown";
		(Gt = ".bs.dropdown"), (Wt = ".data-api");
		const $1 = "ArrowDown";
		($t = "click" + Gt + Wt), (u1 = "keydown" + Gt + Wt);
		const K1 = "show",
			C = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',
			Y1 = (C, ".dropdown-menu"),
			Q1 = o() ? "top-end" : "top-start",
			J1 = o() ? "top-start" : "top-end",
			te = o() ? "bottom-end" : "bottom-start",
			ee = o() ? "bottom-start" : "bottom-end",
			ae = o() ? "left-start" : "right-start",
			ie = o() ? "right-start" : "left-start",
			re = {
				autoClose: !0,
		...
		class A extends e {
			constructor(t, e) {
				super(t, e),
					...
					(this._menu =
						p.next(this._element, Y1)[0] ||
						p.prev(this._element, Y1)[0] ||
						p.findOne(Y1, this._parent)),
			...
			show() {
				if (!s(this._element) && !this._isShown()) {
					var t = { relatedTarget: this._element },
						e = g.trigger(this._element, "show.bs.dropdown", t);
					if (!e.defaultPrevented) {
						if (
							(this._createPopper(),
							"ontouchstart" in document.documentElement &&
						...
						this._element.focus(),
							...
							this._menu.classList.add(K1),
							this._element.classList.add(K1),
							g.trigger(this._element, "shown.bs.dropdown", t);
					}
				}
			}
			hide() {
			...
			_completeHide(t) {
				var e = g.trigger(this._element, "hide.bs.dropdown", t);
				if (!e.defaultPrevented) {
					if ("ontouchstart" in document.documentElement)
						for (const a of [].concat(...document.body.children))
							g.off(a, "mouseover", N);
					this._popper && this._popper.destroy(),
						this._menu.classList.remove(K1),
						this._element.classList.remove(K1),
						this._element.setAttribute("aria-expanded", "false"),
						l.removeDataAttribute(this._menu, "popper"),
						g.trigger(this._element, "hidden.bs.dropdown", t);
				}
			}
			_getConfig(t) {
				if (
			...
			_createPopper() {
				...
				this._popper = U1(t, this._menu, e);
			}
			_isShown() {
				return this._menu.classList.contains(K1);
			}
			_getPlacement() {
				var t,
					e = this._parent;
			...
			_getPopperConfig() {
				...
				return (
					...
					{ ...t, ...d(this._config.popperConfig, [t]) }
				);
			}
			_selectMenuItem({ key: t, target: e }) {
				var a = p
					...
					.filter((t) => n(t));
				a.length && G(a, e, t === $1, !a.includes(e)).focus();
			}
			static jQueryInterface(e) {
				return this.each(function () {
				...
				if (2 !== t.button && ("keyup" !== t.type || "Tab" === t.key))
					for (const r of p.find(
						...
						i &&
							...
							((e = (a = t.composedPath()).includes(i._menu)),
			...
			static dataApiKeydownHandler(t) {
				...
				(!i && !a) ||
					...
					(e = this.matches(C)
						...
						: p.prev(this, C)[0] ||
						  p.next(this, C)[0] ||
						  p.findOne(C, t.delegateTarget.parentNode)),
					(a = A.getOrCreateInstance(e)),
					i
						? (t.stopPropagation(), a.show(), a._selectMenuItem(t))
						: a._isShown() &&
						  (t.stopPropagation(), a.hide(), e.focus()));
			}
		}
		g.on(document, u1, C, A.dataApiKeydownHandler),
			g.on(document, u1, Y1, A.dataApiKeydownHandler),
			g.on(document, $t, A.clearMenus),
			g.on(document, "keyup.bs.dropdown.data-api", A.clearMenus),
			g.on(document, $t, C, function (t) {
		...
		const pe = ".bs.focustrap",
			ce = (pe, pe, "backward"),
			ve = { autofocus: !0, trapElement: null },
			ue = { autofocus: "boolean", trapElement: "element" };
		class ge extends pt {
			constructor(t) {
				super(),
					(this._config = this._getConfig(t)),
			...
			activate() {
				this._isActive ||
					...
					g.off(document, pe),
					g.on(document, "focusin.bs.focustrap", (t) =>
						this._handleFocusin(t)
					),
					g.on(document, "keydown.tab.bs.focustrap", (t) =>
						this._handleKeydown(t)
					),
					(this._isActive = !0));
			}
			deactivate() {
				this._isActive && ((this._isActive = !1), g.off(document, pe));
			}
			_handleFocusin(t) {
		...
		class xe {
			...
			hide() {
				...
				this._disableOverFlow(),
					...
					this._setElementAttributes(Me, me, (t) => t + e),
					this._setElementAttributes(fe, ye, (t) => t - e);
			}
			reset() {
				this._resetElementAttributes(this._element, "overflow"),
					this._resetElementAttributes(this._element, me),
					this._resetElementAttributes(Me, me),
					this._resetElementAttributes(fe, ye);
			}
			isOverflowing() {
			...
			_saveInitialAttribute(t, e) {
				...
				a && l.setDataAttribute(t, e, a);
			}
			_resetElementAttributes(t, a) {
				this._applyManipulationCallback(t, (t) => {
					var e = l.getDataAttribute(t, a);
					null === e
						? t.style.removeProperty(a)
						: (l.removeDataAttribute(t, a),
						  t.style.setProperty(a, e));
				});
			}
			_applyManipulationCallback(t, e) {
				if (h(t)) e(t);
				else for (const a of p.find(t, this._element)) e(a);
			}
		}
		const S = ".bs.modal";
		S, S;
		...
		const Ce = "modal-open",
			Ae = "modal-static";
		const Se = { backdrop: !0, focus: !0, keyboard: !0 },
			He = {
		...
		class _e extends e {
			...
			show(t) {
				this._isShown ||
					...
					g.trigger(this._element, be, { relatedTarget: t })
						.defaultPrevented ||
					((this._isShown = !0),
					(this._isTransitioning = !0),
			...
			_initializeFocusTrap() {
				return new ge({ trapElement: this._element });
			}
			_showElement(t) {
				...
				var e = p.findOne(".modal-body", this._dialog);
				e && (e.scrollTop = 0),
					I(this._element),
			...
			_addEventListeners() {
				g.on(this._element, "keydown.dismiss.bs.modal", (t) => {
					"Escape" === t.key &&
						(this._config.keyboard
							? this.hide()
					...
					g.on(this._element, "mousedown.dismiss.bs.modal", (e) => {
						g.one(this._element, "click.dismiss.bs.modal", (t) => {
			...
			_adjustDialog() {
				...
				i &&
					!e &&
					((t = o() ? "paddingLeft" : "paddingRight"),
					(this._element.style[t] = a + "px")),
					!i &&
						e &&
						((t = o() ? "paddingRight" : "paddingLeft"),
						(this._element.style[t] = a + "px"));
			}
			_resetAdjustments() {
			...
			static jQueryInterface(e, a) {
				return this.each(function () {
					var t = _e.getOrCreateInstance(this, e);
					if ("string" == typeof e) {
						if (void 0 === t[e])
							throw new TypeError(`No method named "${e}"`);
						t[e](a);
		...
		g.on(
			...
			function (t) {
				const e = p.getElementFromSelector(this);
				["A", "AREA"].includes(this.tagName) && t.preventDefault(),
					g.one(e, be, (t) => {
						t.defaultPrevented ||
							g.one(e, we, () => {
		...
		class P extends e {
			...
			_addEventListeners() {
				g.on(this._element, "keydown.dismiss.bs.offcanvas", (t) => {
					"Escape" === t.key &&
						(this._config.keyboard
							? this.hide()
							: g.trigger(this._element, Ve));
		...
		function Fe(t, e, a) {
			...
			if (a && "function" == typeof a) return a(t);
			a = new window.DOMParser().parseFromString(t, "text/html");
			for (const n of [].concat(...a.body.querySelectorAll("*"))) {
				var i = n.nodeName.toLowerCase();
				if (Object.keys(e).includes(i)) {
					var r = [].concat(...n.attributes),
						h = [].concat(e["*"] || [], e[i] || []);
					for (const s of r)
						((t, e) => {
							const a = t.nodeName.toLowerCase();
							return e.includes(a)
								? !Pe.has(a) || Boolean(Oe.test(t.nodeValue))
								: e
										.filter((t) => t instanceof RegExp)
										.some((t) => t.test(a));
						})(s, h) || n.removeAttribute(s.nodeName);
				} else n.remove();
			}
		...
		class ze extends pt {
			...
			_checkContent(t) {
				for (var [e, a] of Object.entries(t))
					super._typeCheckConfig({ selector: e, entry: a }, qe);
			}
			_setContent(t, e, a) {
				a = p.findOne(a, t);
				a &&
					((e = this._resolvePossibleFunction(e))
						? h(e)
							? this._putElementInTemplate(r(e), a)
							: this._config.html
							? (a.innerHTML = this._maybeSanitize(e))
							: (a.textContent = e)
						: a.remove());
			}
			_maybeSanitize(t) {
				return this._config.sanitize
					? Fe(t, this._config.allowList, this._config.sanitizeFn)
					: t;
			}
		...
		const Ze = new Set(["sanitize", "allowList", "sanitizeFn"]),
			Ne = "fade";
		const Ie = "show",
			je = "hide.bs.modal",
			We = "hover",
		...
		class Ke extends e {
			...
			hide() {
				if (this._isShown()) {
					...
					if (!t.defaultPrevented) {
						if (
							(this._getTipElement().classList.remove(Ie),
							"ontouchstart" in document.documentElement)
						)
			...
			_createPopper(t) {
				var e = d(this._config.placement, [this, t, this._element]),
					e = Ge[e.toUpperCase()];
				return U1(this._element, t, this._getPopperConfig(e));
			}
			_getOffset() {
				const e = this._config["offset"];
				return "string" == typeof e
			...
			_setListeners() {
				var t, e;
				for (const a of this._config.trigger.split(" "))
					"click" === a
						? g.on(
								this._element,
						...
						: "manual" !== a &&
						  ...
						  g.on(this._element, t, this._config.selector, (t) => {
								var e = this._initializeOnDelegatedTarget(t);
								(e._activeTrigger[
									"focusin" === t.type ? Ue : We
								] = !0),
									e._enter();
						  }),
						  g.on(this._element, e, this._config.selector, (t) => {
								var e = this._initializeOnDelegatedTarget(t);
								(e._activeTrigger[
									"focusout" === t.type ? Ue : We
			...
			_getConfig(t) {
				var e = l.getDataAttributes(this._element);
				for (const a of Object.keys(e)) Ze.has(a) && delete e[a];
				return (
			...
			_getDelegateConfig() {
				...
				for ([t, e] of Object.entries(this._config))
					this.constructor.Default[t] !== e && (a[t] = e);
		...
		class Je extends Ke {
			...
			static jQueryInterface(e) {
				return this.each(function () {
					var t = Je.getOrCreateInstance(this, e);
					if ("string" == typeof e) {
						if (void 0 === t[e])
							throw new TypeError(`No method named "${e}"`);
						t[e]();
		...
		class h2 extends e {
			...
			_maybeEnableSmoothScroll() {
				this._config.smoothScroll &&
					(g.off(this._config.target, t2),
					g.on(this._config.target, t2, a2, (t) => {
			...
			_initializeTargetsAndObservables() {
				...
				(this._targetLinks = new Map()),
					(this._observableSections = new Map());
				for (const e of p.find(a2, this._config.target))
					e.hash &&
						!s(e) &&
						((t = p.findOne(decodeURI(e.hash), this._element)),
						n(t)) &&
			...
			_process(t) {
				this._activeTarget !== t &&
					...
					(this._activeTarget = t).classList.add(e2),
			...
			_clearActiveClass(t) {
				...
				for (const e of p.find(a2 + "." + e2, t))
					e.classList.remove(e2);
			}
			static jQueryInterface(e) {
				return this.each(function () {
					var t = h2.getOrCreateInstance(this, e);
					if ("string" == typeof e) {
						if (
							void 0 === t[e] ||
							e.startsWith("_") ||
		...
		g.on(window, "load.bs.scrollspy.data-api", () => {
			for (const t of p.find('[data-bs-spy="scroll"]'))
				h2.getOrCreateInstance(t);
		}),
			t(h2);
		const n2 = "ArrowRight",
			s2 = "ArrowDown",
		...
		class c2 extends e {
			constructor(t) {
				super(t),
					...
					this._parent &&
						...
						g.on(this._element, "keydown.bs.tab", (t) =>
							this._keydown(t)
						));
			}
			static get NAME() {
			...
			show() {
				...
				this._elemIsActive(a) ||
					((e = (t = this._getActiveElem())
						? g.trigger(t, "hide.bs.tab", { relatedTarget: a })
						: null),
					g.trigger(a, "show.bs.tab", { relatedTarget: t })
						.defaultPrevented) ||
			...
			_activate(t, e) {
				t &&
					(t.classList.add(O),
					this._activate(p.getElementFromSelector(t)),
					this._queueCallback(
						() => {
			...
			_deactivate(t, e) {
				t &&
					...
					this._queueCallback(
						() => {
							"tab" !== t.getAttribute("role")
								? t.classList.remove(d2)
								: (t.setAttribute("aria-selected", !1),
								  t.setAttribute("tabindex", "-1"),
								  this._toggleDropDown(t, !1),
								  g.trigger(t, "hidden.bs.tab", {
										relatedTarget: e,
								  }));
						},
						t,
			...
			_keydown(e) {
				if (
					["ArrowLeft", n2, "ArrowUp", s2, o2, "End"].includes(e.key)
				) {
					e.stopPropagation(), e.preventDefault();
					var a,
						i = this._getChildren().filter((t) => !s(t));
					let t;
					(t = [o2, "End"].includes(e.key)
						? i[e.key === o2 ? 0 : i.length - 1]
						: ((a = [n2, s2].includes(e.key)),
						  G(i, e.target, a, !0))) &&
						(t.focus({ preventScroll: !0 }),
						c2.getOrCreateInstance(t).show());
				}
			}
			_getChildren() {
				return p.find(p2, this._parent);
			}
			_getActiveElem() {
				return (
			...
			_setInitialAttributes(t, e) {
				...
				for (const a of e) this._setInitialAttributesOnChild(a);
			}
			...
			_getInnerElement(t) {
				return t.matches(p2) ? t : p.findOne(p2, t);
			}
			_getOuterElement(t) {
			...
			static jQueryInterface(e) {
				return this.each(function () {
					var t = c2.getOrCreateInstance(this);
					if ("string" == typeof e) {
						if (
							void 0 === t[e] ||
							e.startsWith("_") ||
		...
		g.on(document, "click.bs.tab", m1, function (t) {
			["A", "AREA"].includes(this.tagName) && t.preventDefault(),
				s(this) || c2.getOrCreateInstance(this).show();
		}),
			g.on(window, "load.bs.tab", () => {
				for (const t of p.find(
					'.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]'
				))
					c2.getOrCreateInstance(t);
			}),
			t(c2);
		const v2 = "show",
			u2 = "showing",
			g2 = { animation: "boolean", autohide: "boolean", delay: "number" },
			M2 = { animation: !0, autohide: !0, delay: 5e3 };
		class f2 extends e {
			constructor(t, e) {
				super(t, e),
					(this._timeout = null),
			...
			show() {
				g.trigger(this._element, "show.bs.toast").defaultPrevented ||
					...
					I(this._element),
					this._element.classList.add(v2, u2),
					this._queueCallback(
						() => {
			...
			hide() {
				this.isShown() &&
					!g.trigger(this._element, "hide.bs.toast")
						.defaultPrevented &&
					(this._element.classList.add(u2),
					this._queueCallback(
						() => {
							this._element.classList.add("hide"),
								this._element.classList.remove(u2, v2),
			...
			dispose() {
				this._clearTimeout(),
					this.isShown() && this._element.classList.remove(v2),
					super.dispose();
			}
			isShown() {
			...
			_setListeners() {
				g.on(this._element, "mouseover.bs.toast", (t) =>
					this._onInteraction(t, !0)
				),
					g.on(this._element, "mouseout.bs.toast", (t) =>
						this._onInteraction(t, !1)
					),
					g.on(this._element, "focusin.bs.toast", (t) =>
						this._onInteraction(t, !0)
					),
					g.on(this._element, "focusout.bs.toast", (t) =>
						this._onInteraction(t, !1)
					);
			}
			_clearTimeout() {
			...
			static jQueryInterface(e) {
				return this.each(function () {
					var t = f2.getOrCreateInstance(this, e);
					if ("string" == typeof e) {
						if (void 0 === t[e])
							throw new TypeError(`No method named "${e}"`);
						t[e](this);
...
var SimpleBar = (function () {
	...
	function y(t) {
		...
		if (
			"string" !=
			typeof (t = m(t)
				? m((e = "function" == typeof t.valueOf ? t.valueOf() : t))
					? e + ""
					: e
				: t)
		)
		...
		t =
			...
			e
				...
				.replace(p, "");
		var e = F.test(t);
		return e || B.test(t) ? R(t.slice(2), e ? 2 : 8) : c.test(t) ? NaN : +t;
	}
	var x = function () {
			return i.Date.now();
		},
	...
	function v(i, a, t) {
		...
		function v(t) {
			var e = r,
				a = h;
			return (r = h = void 0), (l = t), (s = i.apply(a, e));
		}
		function u(t) {
			var e = t - d;
			return void 0 === d || a <= e || e < 0 || (c && n <= t - l);
		}
		function g() {
			var t,
				e = x();
			if (u(e)) return M(e);
			o = setTimeout(g, ((t = a - (e - d)), c ? z(t, n - (e - l)) : t));
		}
		function M(t) {
			return (o = void 0), e && r ? v(t) : ((r = h = void 0), s);
		}
		function f() {
			var t = x(),
				e = u(t);
			if (((r = arguments), (h = this), (d = t), e)) {
				if (void 0 === o)
					return (l = t = d), (o = setTimeout(g, a)), p ? v(t) : s;
				if (c) return clearTimeout(o), (o = setTimeout(g, a)), v(d);
			}
			return void 0 === o && (o = setTimeout(g, a)), s;
		}
		return (
			(a = y(a) || 0),
			m(t) &&
				((p = !!t.leading),
				(n = (c = "maxWait" in t) ? q(y(t.maxWait) || 0, a) : n),
				(e = "trailing" in t ? !!t.trailing : e)),
			(f.cancel = function () {
				void 0 !== o && clearTimeout(o), (r = d = h = o = void (l = 0));
			}),
			(f.flush = function () {
				return void 0 === o ? s : M(x());
			}),
			f
		);
	}
	...
	function f() {
		if (null === g) {
			if ("undefined" == typeof document) return (g = 0);
			var t = document.body,
	...
	t &&
		window.addEventListener("resize", function () {
			M !== window.devicePixelRatio &&
				((M = window.devicePixelRatio), (g = null));
		});
	function C(t) {
	...
	function A(t, e) {
		t && (t = t.classList).add.apply(t, e.split(" "));
	}
	function S(e, t) {
		e &&
		...
		E =
				...
				if (!O.rtlHelpers) {
					var t = document.createElement("div"),
						t =
							...
							t.firstElementChild),
						e = null == t ? void 0 : t.firstElementChild;
					if (!e) return null;
					document.body.appendChild(t), (t.scrollLeft = 0);
					var a = O.getOffset(t),
						i = O.getOffset(e),
						e = ((t.scrollLeft = -999), O.getOffset(e));
					document.body.removeChild(t),
						(O.rtlHelpers = {
							isScrollOriginAtZero: a.left !== i.left,
							isScrollingToNegative: i.left !== e.left,
						});
				}
				return O.rtlHelpers;
			}),
			...
			(O.getOffset = function (t) {
				...
				return {
					...
					left:
						e.left +
						(t.pageXOffset || a.documentElement.scrollLeft),
				};
			}),
			(O.prototype.init = function () {
				t &&
					(this.initDOM(),
					(this.rtlHelpers = O.getRtlHelpers()),
			...
			(O.prototype.initDOM = function () {
				...
				(this.wrapperEl = this.el.querySelector(
					T(this.classNames.wrapper)
				)),
					(this.contentWrapperEl =
						this.options.scrollableNode ||
						this.el.querySelector(
							T(this.classNames.contentWrapper)
						)),
					(this.contentEl =
						this.options.contentNode ||
						this.el.querySelector(T(this.classNames.contentEl))),
					(this.offsetEl = this.el.querySelector(
						T(this.classNames.offset)
					)),
					(this.maskEl = this.el.querySelector(
						T(this.classNames.mask)
					)),
					(this.placeholderEl = this.findChild(
						this.wrapperEl,
						T(this.classNames.placeholder)
					)),
					(this.heightAutoObserverWrapperEl = this.el.querySelector(
						T(this.classNames.heightAutoObserverWrapperEl)
					)),
					(this.heightAutoObserverEl = this.el.querySelector(
						T(this.classNames.heightAutoObserverEl)
					)),
					(this.axis.x.track.el = this.findChild(
						this.el,
						""
							.concat(T(this.classNames.track))
							.concat(T(this.classNames.horizontal))
					)),
					(this.axis.y.track.el = this.findChild(
						this.el,
						""
							.concat(T(this.classNames.track))
							.concat(T(this.classNames.vertical))
					)),
					(this.axis.x.scrollbar.el =
						(null == (t = this.axis.x.track.el)
							? void 0
							: t.querySelector(T(this.classNames.scrollbar))) ||
						null),
				...
				this.el.addEventListener("mouseenter", this.onMouseEnter),
					...
					this.contentEl &&
						(window.ResizeObserver &&
							((t = !1),
							(e = i.ResizeObserver || ResizeObserver),
							(this.resizeObserver = new e(function () {
								t &&
			...
			(O.prototype.recalculate = function () {
				...
				this.heightAutoObserverEl &&
					...
					(n = this.heightAutoObserverEl.offsetWidth <= 1 || 0 < s),
					(t = this.contentWrapperEl.offsetWidth),
					(e = this.elStyles.overflowX),
					...
					(this.contentWrapperEl.style.height = h ? "auto" : "100%"),
					(this.placeholderEl.style.width = n
						? "".concat(s || r, "px")
						: "auto"),
					(this.placeholderEl.style.height = "".concat(i, "px")),
					(h = this.contentWrapperEl.offsetHeight),
					(this.axis.x.isOverflowing = 0 !== s && s < r),
					(this.axis.y.isOverflowing = h < i),
					(this.axis.x.isOverflowing =
						"hidden" !== e && this.axis.x.isOverflowing),
					...
					(n = this.axis.x.isOverflowing ? this.scrollbarWidth : 0),
					(s = this.axis.y.isOverflowing ? this.scrollbarWidth : 0),
					(this.axis.x.isOverflowing =
						this.axis.x.isOverflowing && t - s < r),
					(this.axis.y.isOverflowing =
						this.axis.y.isOverflowing && h - n < i),
			...
			(O.prototype.getScrollbarSize = function (t) {
				var e, a;
				return this.axis[(t = void 0 === t ? "y" : t)].isOverflowing &&
					this.contentEl
					? ((e = this.contentEl[this.axis[t].scrollSizeAttr]),
					  (t =
							null !=
							(a =
								null == (a = this.axis[t].track.el)
									? void 0
									: a[this.axis[t].offsetSizeAttr])
								? a
								: 0),
					  (a = Math.max(
							~~((t / e) * t),
					  ...
					  this.options.scrollbarMaxSize
							? Math.min(a, this.options.scrollbarMaxSize)
							: a)
					: 0;
			}),
			(O.prototype.positionScrollbar = function (t) {
				var e,
					a,
					i,
					r,
					h,
					n = this.axis[(t = void 0 === t ? "y" : t)].scrollbar;
					...
					"x" === t &&
						...
						(r =
							...
							h.isScrollingToNegative
								...
								: -r),
					(h = ~~((a - n.size) * (r / (e - i)))),
					(h = "x" === t && this.isRtl ? -h + (a - n.size) : h),
					(n.el.style.transform =
						"x" === t
							? "translate3d(".concat(h, "px, 0, 0)")
							: "translate3d(0, ".concat(h, "px, 0)")));
			}),
			(O.prototype.toggleTrackVisibility = function (t) {
			...
			(O.prototype.showScrollbar = function (t) {
				this.axis[(t = void 0 === t ? "y" : t)].isOverflowing &&
					!this.axis[t].scrollbar.isVisible &&
					(k(this.axis[t].scrollbar.el, this.classNames.visible),
					(this.axis[t].scrollbar.isVisible = !0));
			}),
			(O.prototype.hideScrollbar = function (t) {
				this.axis[(t = void 0 === t ? "y" : t)].isOverflowing &&
					this.axis[t].scrollbar.isVisible &&
					(V(this.axis[t].scrollbar.el, this.classNames.visible),
			...
			(O.prototype.onMouseMoveForAxis = function (t) {
				var e = this.axis[(t = void 0 === t ? "y" : t)];
				e.track.el &&
					e.scrollbar.el &&
					...
					this.isWithinBounds(e.track.rect)
						? (this.showScrollbar(t),
						  k(e.track.el, this.classNames.hover),
						  (this.isWithinBounds(e.scrollbar.rect) ? k : V)(
								e.scrollbar.el,
			...
			(O.prototype.onMouseLeaveForAxis = function (t) {
				V(
					this.axis[(t = void 0 === t ? "y" : t)].track.el,
					this.classNames.hover
				),
					V(this.axis[t].scrollbar.el, this.classNames.hover),
					this.options.autoHide && this.hideScrollbar(t);
			}),
			...
			(O.prototype.onTrackClick = function (t, e) {
				var a,
					i,
					r,
					h,
				...
				this.options.clickOnTrack &&
					...
					(t =
						null !=
						(o =
							null == (t = this.axis[e].scrollbar.rect)
								? void 0
								: t[this.axis[e].offsetAttr])
							? o
							: 0),
					(o = parseInt(
						null !=
							(o =
								null == (o = this.elStyles)
									? void 0
									: o[this.axis[e].sizeAttr])
							? o
							: "0px",
						10
					)),
					(i = this.contentWrapperEl[this.axis[e].scrollOffsetAttr]),
					(r =
						("y" === e ? this.mouseY - t : this.mouseX - t) < 0
							? -1
							: 1),
					(h = -1 === r ? i - o : i + o),
					(n = function () {
			...
			(O.prototype.isWithinBounds = function (t) {
				return (
					this.mouseX >= t.left &&
			...
			(O.prototype.findChild = function (t, e) {
				var a =
					t.matches ||
		...
		a = (function (i) {
			function r() {
				for (var t = [], e = 0; e < arguments.length; e++)
					t[e] = arguments[e];
				var a = i.apply(this, t) || this;
				return r.instances.set(t[0], a), a;
			}
			var t = r,
				e = i;
			...
			return (
						...
						Array.prototype.forEach.call(
							...
							function (t) {
								"init" === t.getAttribute("data-simplebar") ||
									r.instances.has(t) ||
									new r(t, D(t.attributes));
							}
						);
				}),
				(r.removeObserver = function () {
					var t;
					null != (t = r.globalObserver) && t.disconnect();
				}),
				(r.prototype.initDOM = function () {
					...
					if (
						...
						for (
							this.wrapperEl = document.createElement("div"),
								...
								this.heightAutoObserverEl =
									document.createElement("div"),
								P(this.wrapperEl, this.classNames.wrapper),
								P(
									this.contentWrapperEl,
									this.classNames.contentWrapper
								),
								P(this.offsetEl, this.classNames.offset),
								P(this.maskEl, this.classNames.mask),
								P(this.contentEl, this.classNames.contentEl),
								P(
									this.placeholderEl,
					...
					(this.axis.x.track.el && this.axis.y.track.el) ||
						...
						(e = document.createElement("div")),
						P(t, this.classNames.track),
						P(e, this.classNames.scrollbar),
						t.appendChild(e),
						(this.axis.x.track.el = t.cloneNode(!0)),
						P(this.axis.x.track.el, this.classNames.horizontal),
						(this.axis.y.track.el = t.cloneNode(!0)),
						P(this.axis.y.track.el, this.classNames.vertical),
						this.el.appendChild(this.axis.x.track.el),
						this.el.appendChild(this.axis.y.track.el)),
						E.prototype.initDOM.call(this),
						this.el.setAttribute("data-simplebar", "init");
				}),
				(r.prototype.unMount = function () {
					E.prototype.unMount.call(this), r.instances.delete(this.el);
				}),
	...
	function O(t, e) {
		...
		if (
			...
			(this.onScroll = function () {
				...
				n.scrollXTicking ||
					...
					n.scrollYTicking ||
						...
						(n.scrollYTicking = !0)),
					n.isScrolling ||
						((n.isScrolling = !0), k(n.el, n.classNames.scrolling)),
					n.showScrollbar("x"),
					n.showScrollbar("y"),
					n.onStopScrolling();
			}),
			...
			(this.onMouseEnter = function () {
				n.isMouseEntering ||
					(k(n.el, n.classNames.mouseEntered),
					n.showScrollbar("x"),
					n.showScrollbar("y"),
					(n.isMouseEntering = !0)),
					n.onMouseEntered();
			...
			(this._onMouseEntered = function () {
				V(n.el, n.classNames.mouseEntered),
					n.options.autoHide &&
						(n.hideScrollbar("x"), n.hideScrollbar("y")),
					(n.isMouseEntering = !1);
			}),
			...
			(this.onPointerEvent = function (t) {
				...
				n.axis.x.track.el &&
					...
					(n.axis.y.isOverflowing || n.axis.y.forceVisible) &&
						(a = n.isWithinBounds(n.axis.y.track.rect)),
					e || a) &&
					(t.stopPropagation(), "pointerdown" === t.type) &&
					"touch" !== t.pointerType &&
					(e &&
			...
			(this.drag = function (t) {
				...
				n.draggedAxis &&
					...
					((e =
						null !=
						(e =
							null == (e = (h = n.axis[n.draggedAxis].track).rect)
								? void 0
								: e[n.axis[n.draggedAxis].sizeAttr])
							? e
							: 0),
					(a = n.axis[n.draggedAxis].scrollbar),
					(i =
						null !=
						(i =
							null == (i = n.contentWrapperEl)
								? void 0
								: i[n.axis[n.draggedAxis].scrollSizeAttr])
							? i
							: 0),
					(r = parseInt(
						null !=
							(r =
								null == (r = n.elStyles)
									? void 0
									: r[n.axis[n.draggedAxis].sizeAttr])
							? r
							: "0px",
						10
					)),
					...
					(t =
						...
						(t =
							null == (t = h.rect)
								? void 0
								: t[n.axis[n.draggedAxis].offsetAttr])
							? t
							: 0) -
							...
							"x" === n.draggedAxis && n.isRtl
								? (null !=
								  (h =
										null == (h = h.rect)
											? void 0
											: h[n.axis[n.draggedAxis].sizeAttr])
										? h
										: 0) -
								  a.size -
								  t
			...
			(this.el = t),
			(this.options = u(u({}, O.defaultOptions), e)),
			(this.classNames = u(
				u({}, O.defaultOptions.classNames),
				e.classNames
			)),
			(this.axis = {
				x: {
		...
		(this.onMouseMove = (function (t, e) {
			...
			return (
				...
				v(t, 64, { leading: a, maxWait: 64, trailing: i })
			);
		})(this._onMouseMove)),
			(this.onWindowResize = v(this._onWindowResize, 64, {
				leading: !0,
			})),
			(this.onStopScrolling = v(
				this._onStopScrolling,
				this.stopScrollDelay
			)),
			(this.onMouseEntered = v(
				this._onMouseEntered,
				this.stopScrollDelay
			)),
			this.init();
	}
	return t && a.initHtmlApi(), a;
})();
!(function (t, e) {
	"object" == typeof exports && typeof module < "u"
		...
		? define(["exports"], e)
		: e(
				((t = typeof globalThis < "u" ? globalThis : t || self).lucide =
					{})
		  );
})(this, function (t) {
	"use strict";
	...
	const R = (t) =>
		...
		Z = (t) =>
			t.replace(
				/(\w)(\w*)(_|-|\s*)/g,
				(t, e, a) => e.toUpperCase() + a.toLowerCase()
			),
		N = (t, { nameAttr: e, icons: a, attrs: i }) => {
			var r,
				h,
				n,
				e = t.getAttribute(e);
			if (null != e)
				return (a = a[Z(e)])
					? ((n = R(t)),
					  ([a, h, r] = a),
					  (h = { ...h, "data-lucide": e, ...i, ...n }),
					  (e = z(["lucide", "lucide-" + e, n, i])) &&
							Object.assign(h, { class: e }),
					  (n = B([a, h, r])),
		...
		G = ["svg", e, [["path", { d: "M22 12h-4l-3 9L9 3l-3 9H2" }]]],
		X = [
			"svg",
			e,
			[
		...
		jt = ["svg", e, [["path", { d: "M15 6v6h4l-7 7-7-7h4V6h6z" }]]],
		Wt = [
			"svg",
			e,
			[
		...
		Ut = ["svg", e, [["path", { d: "M18 15h-6v4l-7-7 7-7v4h6v6z" }]]],
		Gt = [
			"svg",
			e,
			[
		...
		Xt = ["svg", e, [["path", { d: "M6 9h6V5l7 7-7 7v-4H6V9z" }]]],
		$t = [
			"svg",
			e,
			[
		...
		Kt = ["svg", e, [["path", { d: "M9 18v-6H5l7-7 7 7h-4v6H9z" }]]],
		Yt = [
			"svg",
			e,
			[
		...
		_e = [
			...
			[
				...
				[
					"rect",
					{ width: "10", height: "6", x: "4", y: "16", rx: "2" },
				],
		...
		Ue = ["svg", e, [["path", { d: "m7 7 10 10-5 5V2l5 5L7 17" }]]],
		Ge = [
			"svg",
			e,
			[
		...
		$2 = [
			...
			[
				...
				[
					"rect",
					{ width: "16", height: "10", x: "4", y: "12", rx: "3" },
				],
				["path", { d: "M9 12v5" }],
				["path", { d: "M15 12v5" }],
				["path", { d: "M4 17h16" }],
		...
		Ra = ["svg", e, [["path", { d: "M20 6 9 17l-5-5" }]]],
		qa = [
			"svg",
			e,
			[
		...
		ja = ["svg", e, [["path", { d: "m15 18-6-6 6-6" }]]],
		Wa = ["svg", e, [["path", { d: "m9 18 6-6-6-6" }]]],
		Ua = ["svg", e, [["path", { d: "m18 15-6-6-6 6" }]]],
		Ga = [
			"svg",
			e,
			[
		...
		k0 = ["svg", e, [["circle", { cx: "12", cy: "12", r: "10" }]]],
		V0 = [
			"svg",
			e,
			[
		...
		Yr = ["svg", e, [["circle", { cx: "12.1", cy: "12.1", r: "1" }]]],
		Qr = [
			"svg",
			e,
			[
		...
		Un = ["svg", e, [["path", { d: "M2 16s9-15 20-4C11 23 2 8 2 8" }]]],
		Gn = [
			"svg",
			e,
			[
		...
		$n = ["svg", e, [["path", { d: "M17 22V2L7 7l10 5" }]]],
		Kn = ["svg", e, [["path", { d: "M7 22V2l10 5-10 5" }]]],
		Yn = [
			"svg",
			e,
			[
		...
		No = [
			...
			[
				...
				[
					"circle",
					{ cx: "11.5", cy: "12.5", r: ".5", fill: "currentColor" },
				],
				[
					"path",
					{
		...
		ip = ["svg", e, [["path", { d: "M21 12a9 9 0 1 1-6.219-8.56" }]]],
		rp = [
			"svg",
			e,
			[
				...
				[
					"line",
					{ x1: "16.24", x2: "19.07", y1: "16.24", y2: "19.07" },
				],
		...
		dp = [
			...
			[
				...
				[
					"rect",
					{ x: "3", y: "10", width: "18", height: "12", rx: "2" },
				],
		...
		_p = [
			...
			[
				[
					"rect",
					{ width: "16", height: "13", x: "6", y: "4", rx: "2" },
				],
		...
		Qp = ["svg", e, [["path", { d: "M7.9 20A9 9 0 1 0 4 16.1L2 22Z" }]]],
		Jp = [
			"svg",
			e,
			[
		...
		Ec = [
			...
			[
				...
				[
					"rect",
					{ width: "6", height: "10", x: "16", y: "12", rx: "2" },
				],
			],
		],
		Dc = [
			...
			[
				...
				[
					"rect",
					{ width: "10", height: "16", x: "12", y: "4", rx: "2" },
				],
		...
		Zc = ["svg", e, [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z" }]]],
		Nc = [
			"svg",
			e,
			[
		...
		Ic = ["svg", e, [["path", { d: "m4 4 7.07 17 2.51-7.39L21 11.07z" }]]],
		jc = [
			"svg",
			e,
			[
		...
		F5 = [
			...
			[
				...
				[
					"rect",
					{ width: "10", height: "7", x: "12", y: "13", rx: "2" },
				],
			],
		],
		B5 = [
			...
			[
				...
				[
					"rect",
					{ width: "10", height: "7", x: "12", y: "13.5", ry: "2" },
				],
			],
		],
		R5 = [
		...
		Y5 = ["svg", e, [["polygon", { points: "6 3 20 12 6 21 6 3" }]]],
		Q5 = [
			"svg",
			e,
			[
		...
		A3 = ["svg", e, [["path", { d: "M3 12h4l3 9 4-17h7" }]]],
		S3 = [
			"svg",
			e,
			[
		...
		Nu = ["svg", e, [["path", { d: "M18 7V4H6l6 8-6 8h12v-3" }]]],
		Iu = [
			"svg",
			e,
			[
	...
	var df = Object.freeze({
		...
		AlertTriangle: b7,
		AlignCenter: at,
		AlignCenterHorizontal: tt,
		AlignCenterVertical: et,
		AlignEndHorizontal: it,
		AlignEndVertical: rt,
		AlignHorizontalDistributeCenter: ht,
		AlignHorizontalDistributeEnd: nt,
		AlignHorizontalDistributeStart: st,
		AlignHorizontalJustifyCenter: ot,
		AlignHorizontalJustifyEnd: dt,
		AlignHorizontalJustifyStart: lt,
		AlignHorizontalSpaceAround: pt,
		AlignHorizontalSpaceBetween: ct,
		AlignJustify: vt,
		AlignLeft: ut,
		AlignRight: gt,
		AlignStartHorizontal: Mt,
		AlignStartVertical: ft,
		AlignVerticalDistributeCenter: mt,
		AlignVerticalDistributeEnd: yt,
		AlignVerticalDistributeStart: xt,
		AlignVerticalJustifyCenter: wt,
		AlignVerticalJustifyEnd: bt,
		AlignVerticalJustifyStart: Ct,
		AlignVerticalSpaceAround: At,
		AlignVerticalSpaceBetween: St,
		Ambulance: Ht,
		Ampersand: _t,
		Ampersands: Lt,
		Anchor: kt,
		...
		ArrowDownAz: h,
		ArrowDownCircle: y,
		ArrowDownFromLine: Jt,
		ArrowDownLeft: t1,
		ArrowDownLeftFromCircle: w,
		ArrowDownLeftFromSquare: T6,
		ArrowDownLeftSquare: _6,
		ArrowDownNarrowWide: e1,
		ArrowDownRight: a1,
		ArrowDownRightFromCircle: b,
		ArrowDownRightFromSquare: E6,
		ArrowDownRightSquare: L6,
		ArrowDownSquare: k6,
		ArrowDownToDot: i1,
		ArrowDownToLine: r1,
		ArrowDownUp: h1,
		ArrowDownWideNarrow: n,
		ArrowDownZA: s,
		ArrowDownZa: s,
		ArrowLeft: l1,
		ArrowLeftCircle: x,
		ArrowLeftFromLine: s1,
		ArrowLeftRight: o1,
		ArrowLeftSquare: V6,
		ArrowLeftToLine: d1,
		ArrowRight: u1,
		ArrowRightCircle: S,
		ArrowRightFromLine: p1,
		ArrowRightLeft: c1,
		ArrowRightSquare: O6,
		ArrowRightToLine: v1,
		ArrowUp: A1,
		...
		ArrowUpFromLine: y1,
		ArrowUpLeft: x1,
		ArrowUpLeftFromCircle: C,
		ArrowUpLeftFromSquare: D6,
		ArrowUpLeftSquare: F6,
		ArrowUpNarrowWide: d,
		ArrowUpRight: w1,
		ArrowUpRightFromCircle: A,
		ArrowUpRightFromSquare: P6,
		ArrowUpRightSquare: B6,
		ArrowUpSquare: R6,
		ArrowUpToLine: b1,
		ArrowUpWideNarrow: C1,
		ArrowUpZA: l,
		ArrowUpZa: l,
		ArrowsUpFromLine: S1,
		Asterisk: H1,
		...
		BadgePercent: j1,
		BadgePlus: W1,
		BadgePoundSterling: U1,
		BadgeRussianRuble: G1,
		BadgeSwissFranc: X1,
		BadgeX: $1,
		BaggageClaim: Y1,
		Ban: Q1,
		...
		BetweenHorizonalStart: u,
		BetweenHorizontalEnd: v,
		BetweenHorizontalStart: u,
		BetweenVerticalEnd: De,
		BetweenVerticalStart: Pe,
		Bike: Oe,
		Binary: Fe,
		Biohazard: Be,
		Bird: Re,
		...
		Blocks: Ne,
		Bluetooth: Ue,
		BluetoothConnected: Ie,
		BluetoothOff: je,
		BluetoothSearching: We,
		Bold: Ge,
		Bolt: Xe,
		Bomb: $e,
		Bone: Ke,
		...
		ChevronDown: Za,
		ChevronDownCircle: k,
		ChevronDownSquare: I6,
		ChevronFirst: Na,
		ChevronLast: Ia,
		ChevronLeft: ja,
		ChevronLeftCircle: V,
		ChevronLeftSquare: j6,
		ChevronRight: Wa,
		ChevronRightCircle: T,
		ChevronRightSquare: W6,
		ChevronUp: Ua,
		ChevronUpCircle: E,
		ChevronUpSquare: U6,
		ChevronsDown: Xa,
		...
		CircleArrowOutDownRight: b,
		CircleArrowOutUpLeft: C,
		CircleArrowOutUpRight: A,
		CircleArrowRight: S,
		CircleArrowUp: H,
		CircleCheck: L,
		CircleCheckBig: _,
		...
		Fullscreen: Ys,
		FunctionSquare: eg,
		GalleryHorizontal: Js,
		GalleryHorizontalEnd: Qs,
		GalleryThumbnails: to,
		GalleryVertical: ao,
		GalleryVerticalEnd: eo,
		Gamepad: ro,
		Gamepad2: io,
		GanttChart: ho,
		GanttChartSquare: ag,
		...
		GitBranchPlus: co,
		GitCommit: uo,
		GitCommitHorizontal: uo,
		GitCommitVertical: go,
		GitCompare: fo,
		GitCompareArrows: Mo,
		GitFork: mo,
		GitGraph: yo,
		GitMerge: xo,
		GitPullRequest: Ho,
		GitPullRequestArrow: wo,
		GitPullRequestClosed: bo,
		GitPullRequestCreate: Ao,
		GitPullRequestCreateArrow: Co,
		GitPullRequestDraft: So,
		Github: _o,
		Gitlab: Lo,
		GlassWater: ko,
		Glasses: Vo,
		...
		Merge: Zp,
		MessageCircle: Qp,
		MessageCircleCode: Np,
		MessageCircleDashed: Ip,
		MessageCircleHeart: jp,
		MessageCircleMore: Wp,
		MessageCircleOff: Up,
		MessageCirclePlus: Gp,
		MessageCircleQuestion: Xp,
		MessageCircleReply: $p,
		MessageCircleWarning: Kp,
		MessageCircleX: Yp,
		MessageSquare: vc,
		MessageSquareCode: Jp,
		MessageSquareDashed: tc,
		MessageSquareDiff: ec,
		MessageSquareDot: ac,
		MessageSquareHeart: ic,
		MessageSquareMore: rc,
		MessageSquareOff: hc,
		MessageSquarePlus: nc,
		MessageSquareQuote: sc,
		MessageSquareReply: oc,
		MessageSquareShare: dc,
		MessageSquareText: lc,
		MessageSquareWarning: pc,
		MessageSquareX: cc,
		MessagesSquare: uc,
		Mic: fc,
		Mic2: Mc,
		...
		MousePointer: Wc,
		MousePointer2: Ic,
		MousePointerClick: jc,
		MousePointerSquareDashed: Y6,
		Move: n4,
		Move3D: Gc,
		Move3d: Gc,
		MoveDiagonal: $c,
		...
		PanelBottom: X4,
		PanelBottomClose: W4,
		PanelBottomDashed: U4,
		PanelBottomInactive: U4,
		PanelBottomOpen: G4,
		PanelLeft: Q4,
		PanelLeftClose: $4,
		PanelLeftDashed: K4,
		PanelLeftInactive: K4,
		PanelLeftOpen: Y4,
		PanelRight: a5,
		PanelRightClose: J4,
		PanelRightDashed: t5,
		PanelRightInactive: t5,
		PanelRightOpen: e5,
		PanelTop: n5,
		PanelTopClose: i5,
		PanelTopDashed: r5,
		...
		ReceiptCent: D3,
		ReceiptEuro: P3,
		ReceiptIndianRupee: O3,
		ReceiptJapaneseYen: F3,
		ReceiptPoundSterling: B3,
		ReceiptRussianRuble: R3,
		ReceiptSwissFranc: q3,
		ReceiptText: z3,
		RectangleEllipsis: N3,
		RectangleHorizontal: I3,
		RectangleVertical: j3,
		Recycle: W3,
		Redo: X3,
		Redo2: U3,
		RedoDot: G3,
		...
		School2: N7,
		Scissors: Xv,
		ScissorsLineDashed: Gv,
		ScissorsSquare: mg,
		ScissorsSquareDashedBottom: z6,
		ScreenShare: Kv,
		ScreenShareOff: $v,
		Scroll: Qv,
		ScrollText: Yv,
		...
		SendHorizontal: ru,
		SendToBack: hu,
		SeparatorHorizontal: su,
		SeparatorVertical: ou,
		Server: cu,
		ServerCog: du,
		ServerCrash: lu,
		ServerOff: pu,
		...
		Slice: a6,
		Sliders: r6,
		SlidersHorizontal: i6,
		SlidersVertical: r6,
		Smartphone: s6,
		SmartphoneCharging: h6,
		SmartphoneNfc: n6,
		Smile: d6,
		SmilePlus: o6,
		Snail: l6,
		...
		Spline: b6,
		Split: C6,
		SplitSquareHorizontal: wg,
		SplitSquareVertical: bg,
		SprayCan: A6,
		Sprout: S6,
		Square: Lg,
		SquareActivity: H6,
		SquareArrowDown: k6,
		SquareArrowDownLeft: _6,
		SquareArrowDownRight: L6,
		SquareArrowLeft: V6,
		SquareArrowOutDownLeft: T6,
		SquareArrowOutDownRight: E6,
		SquareArrowOutUpLeft: D6,
		SquareArrowOutUpRight: P6,
		SquareArrowRight: O6,
		SquareArrowUp: R6,
		SquareArrowUpLeft: F6,
		SquareArrowUpRight: B6,
		SquareAsterisk: q6,
		SquareBottomDashedScissors: z6,
		SquareCheck: N6,
		SquareCheckBig: Z6,
		SquareChevronDown: I6,
		SquareChevronLeft: j6,
		SquareChevronRight: W6,
		SquareChevronUp: U6,
		SquareCode: G6,
		SquareDashedBottom: $6,
		SquareDashedBottomCode: X6,
		SquareDashedKanban: K6,
		SquareDashedMousePointer: Y6,
		SquareDivide: Q6,
		SquareDot: J6,
		SquareEqual: tg,
		SquareFunction: eg,
		...
		SquareSigma: yg,
		SquareSlash: xg,
		SquareSplitHorizontal: wg,
		SquareSplitVertical: bg,
		SquareStack: Cg,
		SquareTerminal: Ag,
		SquareUser: Hg,
		SquareUserRound: Sg,
	...
	(t.AArrowDown = I),
		...
		(t.AlertTriangle = b7),
		(t.AlignCenter = at),
		(t.AlignCenterHorizontal = tt),
		(t.AlignCenterVertical = et),
		(t.AlignEndHorizontal = it),
		(t.AlignEndVertical = rt),
		(t.AlignHorizontalDistributeCenter = ht),
		(t.AlignHorizontalDistributeEnd = nt),
		(t.AlignHorizontalDistributeStart = st),
		(t.AlignHorizontalJustifyCenter = ot),
		(t.AlignHorizontalJustifyEnd = dt),
		(t.AlignHorizontalJustifyStart = lt),
		(t.AlignHorizontalSpaceAround = pt),
		(t.AlignHorizontalSpaceBetween = ct),
		(t.AlignJustify = vt),
		(t.AlignLeft = ut),
		(t.AlignRight = gt),
		(t.AlignStartHorizontal = Mt),
		(t.AlignStartVertical = ft),
		(t.AlignVerticalDistributeCenter = mt),
		(t.AlignVerticalDistributeEnd = yt),
		(t.AlignVerticalDistributeStart = xt),
		(t.AlignVerticalJustifyCenter = wt),
		(t.AlignVerticalJustifyEnd = bt),
		(t.AlignVerticalJustifyStart = Ct),
		(t.AlignVerticalSpaceAround = At),
		(t.AlignVerticalSpaceBetween = St),
		(t.Ambulance = Ht),
		(t.Ampersand = _t),
		(t.Ampersands = Lt),
		(t.Anchor = kt),
		...
		(t.Armchair = Nt),
		(t.ArrowBigDown = jt),
		(t.ArrowBigDownDash = It),
		(t.ArrowBigLeft = Ut),
		(t.ArrowBigLeftDash = Wt),
		(t.ArrowBigRight = Xt),
		(t.ArrowBigRightDash = Gt),
		(t.ArrowBigUp = Kt),
		(t.ArrowBigUpDash = $t),
		(t.ArrowDown = n1),
		(t.ArrowDown01 = Yt),
		...
		(t.ArrowDownAz = h),
		(t.ArrowDownCircle = y),
		(t.ArrowDownFromLine = Jt),
		(t.ArrowDownLeft = t1),
		(t.ArrowDownLeftFromCircle = w),
		(t.ArrowDownLeftFromSquare = T6),
		(t.ArrowDownLeftSquare = _6),
		(t.ArrowDownNarrowWide = e1),
		(t.ArrowDownRight = a1),
		(t.ArrowDownRightFromCircle = b),
		(t.ArrowDownRightFromSquare = E6),
		(t.ArrowDownRightSquare = L6),
		(t.ArrowDownSquare = k6),
		(t.ArrowDownToDot = i1),
		(t.ArrowDownToLine = r1),
		(t.ArrowDownUp = h1),
		(t.ArrowDownWideNarrow = n),
		(t.ArrowDownZA = s),
		(t.ArrowDownZa = s),
		(t.ArrowLeft = l1),
		(t.ArrowLeftCircle = x),
		(t.ArrowLeftFromLine = s1),
		(t.ArrowLeftRight = o1),
		(t.ArrowLeftSquare = V6),
		(t.ArrowLeftToLine = d1),
		(t.ArrowRight = u1),
		(t.ArrowRightCircle = S),
		(t.ArrowRightFromLine = p1),
		(t.ArrowRightLeft = c1),
		(t.ArrowRightSquare = O6),
		(t.ArrowRightToLine = v1),
		(t.ArrowUp = A1),
		(t.ArrowUp01 = g1),
		(t.ArrowUp10 = M1),
		(t.ArrowUpAZ = o),
		...
		(t.ArrowUpDown = f1),
		(t.ArrowUpFromDot = m1),
		(t.ArrowUpFromLine = y1),
		(t.ArrowUpLeft = x1),
		(t.ArrowUpLeftFromCircle = C),
		(t.ArrowUpLeftFromSquare = D6),
		(t.ArrowUpLeftSquare = F6),
		(t.ArrowUpNarrowWide = d),
		(t.ArrowUpRight = w1),
		(t.ArrowUpRightFromCircle = A),
		(t.ArrowUpRightFromSquare = P6),
		(t.ArrowUpRightSquare = B6),
		(t.ArrowUpSquare = R6),
		(t.ArrowUpToLine = b1),
		(t.ArrowUpWideNarrow = C1),
		(t.ArrowUpZA = l),
		(t.ArrowUpZa = l),
		(t.ArrowsUpFromLine = S1),
		(t.Asterisk = H1),
		(t.AsteriskSquare = q6),
		(t.AtSign = _1),
		(t.Atom = L1),
		...
		(t.BadgeCent = F1),
		(t.BadgeCheck = c),
		(t.BadgeDollarSign = B1),
		(t.BadgeEuro = R1),
		(t.BadgeHelp = q1),
		(t.BadgeIndianRupee = z1),
		(t.BadgeInfo = Z1),
		(t.BadgeJapaneseYen = N1),
		(t.BadgeMinus = I1),
		(t.BadgePercent = j1),
		(t.BadgePlus = W1),
		(t.BadgePoundSterling = U1),
		(t.BadgeRussianRuble = G1),
		(t.BadgeSwissFranc = X1),
		(t.BadgeX = $1),
		(t.BaggageClaim = Y1),
		(t.Ban = Q1),
		(t.Banana = J1),
		...
		(t.BarChartHorizontalBig = he),
		(t.Barcode = oe),
		(t.Baseline = de),
		(t.Bath = le),
		(t.Battery = Me),
		(t.BatteryCharging = pe),
		(t.BatteryFull = ce),
		(t.BatteryLow = ve),
		(t.BatteryMedium = ue),
		(t.BatteryWarning = ge),
		...
		(t.BellPlus = Ve),
		(t.BellRing = Te),
		(t.BetweenHorizonalEnd = v),
		(t.BetweenHorizonalStart = u),
		(t.BetweenHorizontalEnd = v),
		(t.BetweenHorizontalStart = u),
		(t.BetweenVerticalEnd = De),
		(t.BetweenVerticalStart = Pe),
		(t.Bike = Oe),
		(t.Binary = Fe),
		(t.Biohazard = Be),
		(t.Bird = Re),
		...
		(t.Blocks = Ne),
		(t.Bluetooth = Ue),
		(t.BluetoothConnected = Ie),
		(t.BluetoothOff = je),
		(t.BluetoothSearching = We),
		(t.Bold = Ge),
		(t.Bolt = Xe),
		(t.Bomb = $e),
		(t.Bone = Ke),
		...
		(t.BrickWall = F2),
		(t.Briefcase = q2),
		(t.BriefcaseBusiness = B2),
		(t.BriefcaseMedical = R2),
		(t.BringToFront = z2),
		(t.Brush = Z2),
		(t.Bug = j2),
		(t.BugOff = N2),
		...
		(t.Cherry = za),
		(t.ChevronDown = Za),
		(t.ChevronDownCircle = k),
		(t.ChevronDownSquare = I6),
		(t.ChevronFirst = Na),
		(t.ChevronLast = Ia),
		(t.ChevronLeft = ja),
		(t.ChevronLeftCircle = V),
		(t.ChevronLeftSquare = j6),
		(t.ChevronRight = Wa),
		(t.ChevronRightCircle = T),
		(t.ChevronRightSquare = W6),
		(t.ChevronUp = Ua),
		(t.ChevronUpCircle = E),
		(t.ChevronUpSquare = U6),
		(t.ChevronsDown = Xa),
		(t.ChevronsDownUp = Ga),
		(t.ChevronsLeft = Ka),
		(t.ChevronsLeftRight = $a),
		(t.ChevronsRight = Qa),
		(t.ChevronsRightLeft = Ya),
		(t.ChevronsUp = t0),
		(t.ChevronsUpDown = Ja),
		(t.Chrome = e0),
		(t.Church = a0),
		...
		(t.CircleArrowDown = y),
		(t.CircleArrowLeft = x),
		(t.CircleArrowOutDownLeft = w),
		(t.CircleArrowOutDownRight = b),
		(t.CircleArrowOutUpLeft = C),
		(t.CircleArrowOutUpRight = A),
		(t.CircleArrowRight = S),
		(t.CircleArrowUp = H),
		(t.CircleCheck = L),
		(t.CircleCheckBig = _),
		(t.CircleChevronDown = k),
		(t.CircleChevronLeft = V),
		(t.CircleChevronRight = T),
		(t.CircleChevronUp = E),
		(t.CircleDashed = h0),
		(t.CircleDivide = D),
		(t.CircleDollarSign = n0),
		(t.CircleDot = o0),
		(t.CircleDotDashed = s0),
		(t.CircleEllipsis = d0),
		(t.CircleEqual = l0),
		(t.CircleFadingPlus = p0),
		(t.CircleGauge = c0),
		(t.CircleHelp = v0),
		(t.CircleMinus = u0),
		(t.CircleOff = g0),
		(t.CircleParking = f0),
		(t.CircleParkingOff = M0),
		(t.CirclePause = m0),
		(t.CirclePercent = y0),
		(t.CirclePlay = x0),
		(t.CirclePlus = w0),
		...
		(t.ClipboardPaste = B0),
		(t.ClipboardPen = q0),
		(t.ClipboardPenLine = R0),
		(t.ClipboardPlus = z0),
		(t.ClipboardSignature = R0),
		(t.ClipboardType = Z0),
		(t.ClipboardX = N0),
		(t.Clock = ai),
		(t.Clock1 = j0),
		...
		(t.Copyright = Ji),
		(t.CornerDownLeft = tr),
		(t.CornerDownRight = er),
		(t.CornerLeftDown = ar),
		(t.CornerLeftUp = ir),
		(t.CornerRightDown = rr),
		(t.CornerRightUp = hr),
		(t.CornerUpLeft = nr),
		(t.CornerUpRight = sr),
		(t.Cpu = or),
		(t.CreativeCommons = dr),
		(t.CreditCard = lr),
		(t.Croissant = pr),
		(t.Crop = cr),
		(t.Cross = vr),
		...
		(t.FilterX = Zn),
		(t.Fingerprint = In),
		(t.FireExtinguisher = jn),
		(t.Fish = Gn),
		(t.FishOff = Wn),
		(t.FishSymbol = Un),
		(t.Flag = Yn),
		(t.FlagOff = Xn),
		(t.FlagTriangleLeft = $n),
		(t.FlagTriangleRight = Kn),
		(t.Flame = Jn),
		(t.FlameKindling = Qn),
		(t.Flashlight = es),
		(t.FlashlightOff = ts),
		(t.FlaskConical = is),
		(t.FlaskConicalOff = as),
		(t.FlaskRound = rs),
		(t.FlipHorizontal = ns),
		(t.FlipHorizontal2 = hs),
		(t.FlipVertical = os),
		(t.FlipVertical2 = ss),
		(t.Flower = ls),
		(t.Flower2 = ds),
		...
		(t.Fullscreen = Ys),
		(t.FunctionSquare = eg),
		(t.GalleryHorizontal = Js),
		(t.GalleryHorizontalEnd = Qs),
		(t.GalleryThumbnails = to),
		(t.GalleryVertical = ao),
		(t.GalleryVerticalEnd = eo),
		(t.Gamepad = ro),
		(t.Gamepad2 = io),
		(t.GanttChart = ho),
		(t.GanttChartSquare = ag),
		(t.Gauge = no),
		(t.GaugeCircle = c0),
		(t.Gavel = so),
		(t.Gem = oo),
		...
		(t.GitBranchPlus = co),
		(t.GitCommit = uo),
		(t.GitCommitHorizontal = uo),
		(t.GitCommitVertical = go),
		(t.GitCompare = fo),
		(t.GitCompareArrows = Mo),
		(t.GitFork = mo),
		(t.GitGraph = yo),
		(t.GitMerge = xo),
		(t.GitPullRequest = Ho),
		(t.GitPullRequestArrow = wo),
		(t.GitPullRequestClosed = bo),
		(t.GitPullRequestCreate = Ao),
		(t.GitPullRequestCreateArrow = Co),
		(t.GitPullRequestDraft = So),
		(t.Github = _o),
		(t.Gitlab = Lo),
		(t.GlassWater = ko),
		(t.Glasses = Vo),
		...
		(t.Handshake = Yo),
		(t.HardDrive = td),
		(t.HardDriveDownload = Qo),
		(t.HardDriveUpload = Jo),
		(t.HardHat = ed),
		(t.Hash = ad),
		(t.Haze = id),
		(t.HdmiPort = rd),
		...
		(t.Layers3 = wl),
		(t.Layout = d5),
		(t.LayoutDashboard = Cl),
		(t.LayoutGrid = Al),
		(t.LayoutList = Sl),
		(t.LayoutPanelLeft = Hl),
		(t.LayoutPanelTop = _l),
		(t.LayoutTemplate = Ll),
		(t.Leaf = kl),
		(t.LeafyGreen = Vl),
		...
		(t.Merge = Zp),
		(t.MessageCircle = Qp),
		(t.MessageCircleCode = Np),
		(t.MessageCircleDashed = Ip),
		(t.MessageCircleHeart = jp),
		(t.MessageCircleMore = Wp),
		(t.MessageCircleOff = Up),
		(t.MessageCirclePlus = Gp),
		(t.MessageCircleQuestion = Xp),
		(t.MessageCircleReply = $p),
		(t.MessageCircleWarning = Kp),
		(t.MessageCircleX = Yp),
		(t.MessageSquare = vc),
		(t.MessageSquareCode = Jp),
		(t.MessageSquareDashed = tc),
		(t.MessageSquareDiff = ec),
		(t.MessageSquareDot = ac),
		(t.MessageSquareHeart = ic),
		(t.MessageSquareMore = rc),
		(t.MessageSquareOff = hc),
		(t.MessageSquarePlus = nc),
		(t.MessageSquareQuote = sc),
		(t.MessageSquareReply = oc),
		(t.MessageSquareShare = dc),
		(t.MessageSquareText = lc),
		(t.MessageSquareWarning = pc),
		(t.MessageSquareX = cc),
		(t.MessagesSquare = uc),
		(t.Mic = fc),
		(t.Mic2 = Mc),
		...
		(t.MousePointer = Wc),
		(t.MousePointer2 = Ic),
		(t.MousePointerClick = jc),
		(t.MousePointerSquareDashed = Y6),
		(t.Move = n4),
		(t.Move3D = Gc),
		(t.Move3d = Gc),
		(t.MoveDiagonal = $c),
		...
		(t.Palmtree = M7),
		(t.PanelBottom = X4),
		(t.PanelBottomClose = W4),
		(t.PanelBottomDashed = U4),
		(t.PanelBottomInactive = U4),
		(t.PanelBottomOpen = G4),
		(t.PanelLeft = Q4),
		(t.PanelLeftClose = $4),
		(t.PanelLeftDashed = K4),
		(t.PanelLeftInactive = K4),
		(t.PanelLeftOpen = Y4),
		(t.PanelRight = a5),
		(t.PanelRightClose = J4),
		(t.PanelRightDashed = t5),
		(t.PanelRightInactive = t5),
		(t.PanelRightOpen = e5),
		(t.PanelTop = n5),
		(t.PanelTopClose = i5),
		(t.PanelTopDashed = r5),
		(t.PanelTopInactive = r5),
		(t.PanelTopOpen = h5),
		(t.PanelsLeftBottom = s5),
		(t.PanelsLeftRight = Vi),
		(t.PanelsRightBottom = o5),
		(t.PanelsTopBottom = Cv),
		(t.PanelsTopLeft = d5),
		(t.Paperclip = l5),
		(t.Parentheses = p5),
		(t.ParkingCircle = f0),
		(t.ParkingCircleOff = M0),
		(t.ParkingMeter = c5),
		(t.ParkingSquare = lg),
		(t.ParkingSquareOff = dg),
		(t.PartyPopper = v5),
		(t.Pause = u5),
		(t.PauseCircle = m0),
		(t.PauseOctagon = _4),
		...
		(t.Piano = P5),
		(t.Pickaxe = O5),
		(t.PictureInPicture = B5),
		(t.PictureInPicture2 = F5),
		(t.PieChart = R5),
		(t.PiggyBank = q5),
		(t.Pilcrow = N5),
		(t.PilcrowLeft = z5),
		...
		(t.ReceiptCent = D3),
		(t.ReceiptEuro = P3),
		(t.ReceiptIndianRupee = O3),
		(t.ReceiptJapaneseYen = F3),
		(t.ReceiptPoundSterling = B3),
		(t.ReceiptRussianRuble = R3),
		(t.ReceiptSwissFranc = q3),
		(t.ReceiptText = z3),
		(t.RectangleEllipsis = N3),
		(t.RectangleHorizontal = I3),
		(t.RectangleVertical = j3),
		(t.Recycle = W3),
		(t.Redo = X3),
		(t.Redo2 = U3),
		(t.RedoDot = G3),
		...
		(t.School2 = N7),
		(t.Scissors = Xv),
		(t.ScissorsLineDashed = Gv),
		(t.ScissorsSquare = mg),
		(t.ScissorsSquareDashedBottom = z6),
		(t.ScreenShare = Kv),
		(t.ScreenShareOff = $v),
		(t.Scroll = Qv),
		(t.ScrollText = Yv),
		...
		(t.SendHorizontal = ru),
		(t.SendToBack = hu),
		(t.SeparatorHorizontal = su),
		(t.SeparatorVertical = ou),
		(t.Server = cu),
		(t.ServerCog = du),
		(t.ServerCrash = lu),
		(t.ServerOff = pu),
		...
		(t.Slice = a6),
		(t.Sliders = r6),
		(t.SlidersHorizontal = i6),
		(t.SlidersVertical = r6),
		(t.Smartphone = s6),
		(t.SmartphoneCharging = h6),
		(t.SmartphoneNfc = n6),
		(t.Smile = d6),
		(t.SmilePlus = o6),
		(t.Snail = l6),
		...
		(t.Spline = b6),
		(t.Split = C6),
		(t.SplitSquareHorizontal = wg),
		(t.SplitSquareVertical = bg),
		(t.SprayCan = A6),
		(t.Sprout = S6),
		(t.Square = Lg),
		(t.SquareActivity = H6),
		(t.SquareArrowDown = k6),
		(t.SquareArrowDownLeft = _6),
		(t.SquareArrowDownRight = L6),
		(t.SquareArrowLeft = V6),
		(t.SquareArrowOutDownLeft = T6),
		(t.SquareArrowOutDownRight = E6),
		(t.SquareArrowOutUpLeft = D6),
		(t.SquareArrowOutUpRight = P6),
		(t.SquareArrowRight = O6),
		(t.SquareArrowUp = R6),
		(t.SquareArrowUpLeft = F6),
		(t.SquareArrowUpRight = B6),
		(t.SquareAsterisk = q6),
		(t.SquareBottomDashedScissors = z6),
		(t.SquareCheck = N6),
		(t.SquareCheckBig = Z6),
		(t.SquareChevronDown = I6),
		(t.SquareChevronLeft = j6),
		(t.SquareChevronRight = W6),
		(t.SquareChevronUp = U6),
		(t.SquareCode = G6),
		(t.SquareDashedBottom = $6),
		(t.SquareDashedBottomCode = X6),
		(t.SquareDashedKanban = K6),
		(t.SquareDashedMousePointer = Y6),
		(t.SquareDivide = Q6),
		(t.SquareDot = J6),
		(t.SquareEqual = tg),
		(t.SquareFunction = eg),
		(t.SquareGanttChart = ag),
		(t.SquareKanban = ig),
		(t.SquareLibrary = rg),
		(t.SquareM = hg),
		(t.SquareMenu = ng),
		(t.SquareMinus = sg),
		(t.SquareMousePointer = og),
		(t.SquareParking = lg),
		(t.SquareParkingOff = dg),
		(t.SquarePen = O),
		(t.SquarePercent = pg),
		(t.SquarePi = cg),
		(t.SquarePilcrow = vg),
		...
		(t.SquareSigma = yg),
		(t.SquareSlash = xg),
		(t.SquareSplitHorizontal = wg),
		(t.SquareSplitVertical = bg),
		(t.SquareStack = Cg),
		(t.SquareTerminal = Ag),
		(t.SquareUser = Hg),
		(t.SquareUserRound = Sg),
		(t.SquareX = _g),
		(t.Squircle = kg),
		(t.Squirrel = Vg),
		(t.Stamp = Tg),
		...
		(t.StopCircle = S0),
		(t.Store = zg),
		(t.StretchHorizontal = Zg),
		(t.StretchVertical = Ng),
		(t.Strikethrough = Ig),
		(t.Subscript = jg),
		(t.Subtitles = f),
		(t.Sun = $g),
		...
		(t.Table = p8),
		(t.Table2 = h8),
		(t.TableCellsMerge = n8),
		(t.TableCellsSplit = s8),
		(t.TableColumnsSplit = o8),
		(t.TableProperties = d8),
		(t.TableRowsSplit = l8),
		(t.Tablet = v8),
		(t.TabletSmartphone = c8),
		(t.Tablets = u8),
		(t.Tag = g8),
		(t.Tags = M8),
		(t.Tally1 = f8),
		...
		(t.TestTube = k8),
		(t.TestTube2 = L8),
		(t.TestTubeDiagonal = L8),
		(t.TestTubes = V8),
		(t.Text = F8),
		(t.TextCursor = E8),
		(t.TextCursorInput = T8),
		(t.TextQuote = D8),
		(t.TextSearch = P8),
		(t.TextSelect = O8),
		(t.TextSelection = O8),
...
lucide.createIcons({icons});\``);
			...
			Array.from(t).forEach((t) =>
				N(t, { nameAttr: a, icons: e, attrs: i })
			),
				"data-lucide" === a &&
					...
					Array.from(t).forEach((t) =>
						N(t, { nameAttr: "icon-name", icons: e, attrs: i })
					));
		}),
		(t.icons = df);
});
